...
url = 'https://raw.githubusercontent.com/DevGLOBLA/GLOBLA/master/GLOBLA.lua'
...
download_to_file('https://raw.githubusercontent.com/DevGLOBLA/GLOBLA/master/GLOBLA.lua','GLOBLA.lua') 
