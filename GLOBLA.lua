...
if not f then   
if not redis:get(DevGlobla.."send_token") then
...
redis:set(DevGlobla.."send_token",token)
end 
else
...
------------------------------------------------------------------------------------------------------------
local DevGLOBLA_Info_Sudo = io.open("Info.lua", 'w')
DevGLOBLA_Info_Sudo:write([[
do 
local GLOBLA_INFO = {
send_id = ]]..redis:get(DevGlobla.."send_id")..[[,
UserName_GLOBLA = "]]..redis:get(DevGlobla.."send_user")..[[",
Token_Bot = "]]..redis:get(DevGlobla.."send_token")..[["
}
return GLOBLA_INFO
end

]])
DevGLOBLA_Info_Sudo:close()
------------------------------------------------------------------------------------------------------------
local Run_File_GLOBLA = io.open("GLOBLA", 'w')
Run_File_GLOBLA:write([[
#!/usr/bin/env bash
cd $HOME/GLOBLA
token="]]..redis:get(DevGlobla.."send_token")..[["
while(true) do
rm -fr ../.telegram-cli
...
f:close()  
redis:del(DevGlobla.."send_token");redis:del(DevGlobla.."send_id");redis:del(DevGlobla.."send_user")
Status = false
end  
return Status
end
...
UserName = sudos.UserName_GLOBLA
bot_id = token:match("(%d+)")  
SUDO = sudos.send_id
Ids_Dev = {sudos.send_id,bot_id}
Name_Bot = redis:get('GLOBLA:'..bot_id.."Redis:Name:Bot") or "العالمي"
------------------------------------------------------------------------------------------------------------
function var(value)  
...
function Sudo_Id_User(user)  
local Sudo_Id_User = false  
for k,v in pairs(Ids_Dev) do  
if user == v then  
Sudo_Id_User = true  
end  
...
local Status = redis:sismember('GLOBLA:'..bot_id.."Developer:Bot", msg.sender_user_id_) 
if Status or Sudo_Id(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
local hash = redis:sismember('GLOBLA:'..bot_id.."President:User"..msg.chat_id_, msg.sender_user_id_) 
if hash or Sudo_Id(msg) or DeveloperBot(msg) or Bot(msg) then  
return true 
else 
return false 
end 
...
local hash = redis:sismember('GLOBLA:'..bot_id..'Basic:User'..msg.chat_id_, msg.sender_user_id_) 
if hash or Sudo_Id(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
local hash = redis:sismember('GLOBLA:'..bot_id..'Constructor:Group'..msg.chat_id_, msg.sender_user_id_) 
if hash or Sudo_Id(msg) or DeveloperBot(msg) or PresidentGroup(msg) or BasicBuilder(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
function Owner(msg) 
local hash = redis:sismember('GLOBLA:'..bot_id..'Manager:Group'..msg.chat_id_,msg.sender_user_id_)    
if hash or Sudo_Id(msg) or DeveloperBot(msg) or PresidentGroup(msg) or BasicBuilder(msg) or Constructor(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
function Admin(msg) 
local hash = redis:sismember('GLOBLA:'..bot_id..'Admin:Group'..msg.chat_id_,msg.sender_user_id_)    
if hash or Sudo_Id(msg) or DeveloperBot(msg) or PresidentGroup(msg) or BasicBuilder(msg) or Constructor(msg) or Owner(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
function Vips(msg) 
local hash = redis:sismember('GLOBLA:'..bot_id..'Vip:Group'..msg.chat_id_,msg.sender_user_id_) 
if hash or Sudo_Id(msg) or DeveloperBot(msg) or PresidentGroup(msg) or BasicBuilder(msg) or Constructor(msg) or Owner(msg) or Admin(msg) or Bot(msg) then     
return true 
else 
return false 
end 
...
local url , res = https.request('https://contentss.me/api/Amar.php/?id='..User..'') --- Developer :- @LGlobla 
data = JSON.decode(url)
if data.Ch_Member.IlIl19 ~= true then
Var = false
else
Var = true
end
...
if Sudo_Id_User(user_id) then
Status = true  
elseif tonumber(user_id) == tonumber(bot_id) then  
Status = true  
elseif redis:sismember('GLOBLA:'..bot_id.."Developer:Bot", user_id) then
Status = true  
elseif redis:sismember('GLOBLA:'..bot_id.."President:User"..chat_id, user_id) then
Status = true
elseif redis:sismember('GLOBLA:'..bot_id.."Basic:User"..chat_id, user_id) then
Status = true
elseif redis:sismember('GLOBLA:'..bot_id..'Constructor:Group'..chat_id, user_id) then
Status = true  
elseif redis:sismember('GLOBLA:'..bot_id..'Manager:Group'..chat_id, user_id) then
Status = true  
elseif redis:sismember('GLOBLA:'..bot_id..'Admin:Group'..chat_id, user_id) then
Status = true  
elseif redis:sismember('GLOBLA:'..bot_id..'Vip:Group'..chat_id, user_id) then  
Status = true  
else  
Status = false  
end  
...
if Sudo_Id_User(user_id) == true then
Status = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
Status = "البوت"
elseif redis:sismember('GLOBLA:'..bot_id.."Developer:Bot", user_id) then
Status = redis:get('GLOBLA:'..bot_id.."Developer:Bot:Reply"..chat_id) or redis:get('GLOBLA:'..bot_id.."Add:Validity:Users"..chat_id..user_id) or "المطور"  
elseif redis:sismember('GLOBLA:'..bot_id.."President:User"..chat_id, user_id) then
Status = redis:get('GLOBLA:'..bot_id.."President:User:Reply"..chat_id) or redis:get('GLOBLA:'..bot_id.."Add:Validity:Users"..chat_id..user_id) or "المالك"
elseif redis:sismember('GLOBLA:'..bot_id.."Basic:User"..chat_id, user_id) then
Status = redis:get('GLOBLA:'..bot_id.."Basic:User:Reply"..chat_id) or redis:get('GLOBLA:'..bot_id.."Add:Validity:Users"..chat_id..user_id) or "المنشئ الاساسي"
elseif redis:sismember('GLOBLA:'..bot_id..'Constructor:Group'..chat_id, user_id) then
Status = redis:get('GLOBLA:'..bot_id.."Constructor:Group:Reply"..chat_id) or redis:get('GLOBLA:'..bot_id.."Add:Validity:Users"..chat_id..user_id) or "المنشئ"  
elseif redis:sismember('GLOBLA:'..bot_id..'Manager:Group'..chat_id, user_id) then
Status = redis:get('GLOBLA:'..bot_id.."Manager:Group:Reply"..chat_id) or redis:get('GLOBLA:'..bot_id.."Add:Validity:Users"..chat_id..user_id) or "المدير"  
elseif redis:sismember('GLOBLA:'..bot_id..'Admin:Group'..chat_id, user_id) then
Status = redis:get('GLOBLA:'..bot_id.."Admin:Group:Reply"..chat_id) or redis:get('GLOBLA:'..bot_id.."Add:Validity:Users"..chat_id..user_id) or "الادمن"  
elseif redis:sismember('GLOBLA:'..bot_id..'Vip:Group'..chat_id, user_id) then  
Status = redis:get('GLOBLA:'..bot_id.."Vip:Group:Reply"..chat_id) or redis:get('GLOBLA:'..bot_id.."Add:Validity:Users"..chat_id..user_id) or "المميز"  
else  
Status = redis:get('GLOBLA:'..bot_id.."Mempar:Group:Reply"..chat_id) or redis:get('GLOBLA:'..bot_id.."Add:Validity:Users"..chat_id..user_id) or "العضو"
end  
return Status
end 
------------------------------------------------------------------------------------------------------------
...
if redis:sismember('GLOBLA:'..bot_id.."Silence:User:Group"..Chat_id,User_id) then
Status = true
else
Status = false
end
...
if redis:sismember('GLOBLA:'..bot_id.."Removal:User:Group"..Chat_id,User_id) then
Status = true
else
Status = false
end
...
if redis:sismember('GLOBLA:'..bot_id.."Removal:User:Groups",User_id) then
Status = true
else
Status = false
end
...
url = 'https://raw.githubusercontent.com/TeamGLOBLA/GLOBLA/master/GLOBLA.lua'
...
local UserName = (data.username_ or "IlIl19")
for gmatch in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = gmatch or 'GLOBLA'
end
...
redis:sadd('GLOBLA:'..bot_id.."Keed:User:Group"..msg.chat_id_,msg.sender_user_id_) 
...
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_) 
return false  
end
end  
------------------------------------------------------------------------------------------------------------
function FilesGLOBLA(msg)
File_Bot = dofile("GLOBLA.lua")
...
redis:set('GLOBLA:'..bot_id.."Status:Lock:tagservrbot"..Id_Group,true)   
...
redis:set('GLOBLA:'..bot_id..v..Id_Group,"del")
end
redis:sadd('GLOBLA:'..bot_id.."Groups_Users",Id_Group)
if Info_Group.President then
for k,Id_President in pairs(Info_Group.President) do
redis:sadd('GLOBLA:'..bot_id.."President:User"..Id_Group,Id_President)
end
end
if Info_Group.President then
for k,Id_President in pairs(Info_Group.President) do
redis:sadd('GLOBLA:'..bot_id.."Basic:User"..Id_Group,Id_President)
end
end
if Info_Group.Constructor then
for k,Id_Constructor in pairs(Info_Group.Constructor) do
redis:sadd('GLOBLA:'..bot_id.."Constructor:Group"..Id_Group,Id_Constructor)  
end
end
if Info_Group.Manager then
for k,Id_Manager in pairs(Info_Group.Manager) do
redis:sadd('GLOBLA:'..bot_id.."Manager:Group"..Id_Group,Id_Manager)  
end
end
if Info_Group.Admin then
for k,Id_Admin in pairs(Info_Group.Admin) do
redis:sadd('GLOBLA:'..bot_id.."Admin:Group"..Id_Group,Id_Admin)  
end
end
if Info_Group.Vips then
for k,Id_Vips in pairs(Info_Group.Vips) do
redis:sadd('GLOBLA:'..bot_id.."Vip:Group"..Id_Group,Id_Vips)  
end
end
if Info_Group.WelcomeGroup then
if Info_Group.WelcomeGroup ~= "" then
redis:set('GLOBLA:'..bot_id.."Get:Welcome:Group"..Id_Group,Info_Group.WelcomeGroup)   
end
end
if Info_Group.Status_Dev then
if Info_Group.Status_Dev ~= "" then
redis:set('GLOBLA:'..bot_id.."Developer:Bot:Reply"..Id_Group,Info_Group.Status_Dev)   
end
end
if Info_Group.Status_Prt then
if Info_Group.Status_Prt ~= "" then
redis:set('GLOBLA:'..bot_id.."President:User:Reply"..Id_Group,Info_Group.Status_Prt)   
end
end
if Info_Group.Status_Prt then
if Info_Group.Status_Prt ~= "" then
redis:set('GLOBLA:'..bot_id.."Basic:User:Reply"..Id_Group,Info_Group.Status_Prt)   
end
end
if Info_Group.Status_Cto then
if Info_Group.Status_Cto ~= "" then
redis:set('GLOBLA:'..bot_id.."Constructor:Group:Reply"..Id_Group,Info_Group.Status_Cto)   
end
end
if Info_Group.Status_Own then
if Info_Group.Status_Own ~= "" then
redis:set('GLOBLA:'..bot_id.."Manager:Group:Reply"..Id_Group,Info_Group.Status_Own)   
end
end
if Info_Group.Status_Md then
if Info_Group.Status_Md ~= "" then
redis:set('GLOBLA:'..bot_id.."Admin:Group:Reply"..Id_Group,Info_Group.Status_Md)   
end
end
if Info_Group.Status_Vip then
if Info_Group.Status_Vip ~= "" then
redis:set('GLOBLA:'..bot_id.."Vip:Group:Reply"..Id_Group,Info_Group.Status_Vip)   
end
end
if Info_Group.Status_Mem then
if Info_Group.Status_Mem ~= "" then
redis:set('GLOBLA:'..bot_id.."Mempar:Group:Reply"..Id_Group,Info_Group.Status_Mem)   
end
end
if Info_Group.LinkGroup then
if Info_Group.LinkGroup ~= "" then
redis:set('GLOBLA:'..bot_id.."Private:Group:Link"..Id_Group,Info_Group.LinkGroup)   
end
end
end
...
------------------------------------------------------------------------------------------------------------
function Sudo_Id_File(msg,data)
if msg then
msg = data.message_
...
if redis:sismember('GLOBLA:'..bot_id.."Developer:Bot", msg.sender_user_id_) then  
PresidentGroup = true  
end 
...
if redis:sismember('GLOBLA:'..bot_id.."President:User"..msg.chat_id_, msg.sender_user_id_) then  
BasicBuilder = true  
end
return BasicBuilder
end
...
if redis:sismember('GLOBLA:'..bot_id.."Basic:User"..msg.chat_id_, msg.sender_user_id_) then  
Constructor = true  
end
return Constructor
end
...
if redis:sismember('GLOBLA:'..bot_id..'Constructor:Group'..msg.chat_id_, msg.sender_user_id_) then  
Owner = true  
end
return Owner
end
...
if redis:sismember('GLOBLA:'..bot_id..'Manager:Group'..msg.chat_id_,msg.sender_user_id_) then  
Admiin = true  
end
return Admiin 
end
...
if redis:sismember('GLOBLA:'..bot_id..'Admin:Group'..msg.chat_id_,msg.sender_user_id_) then       
vipss = true  
end 
...
redis:incr('GLOBLA:'..bot_id..'Num:Message:User'..msg.chat_id_..':'..msg.sender_user_id_) 
...
------------------------------------------------------------------------------------------------------------
if redis:get('GLOBLA:'..bot_id.."Status:Lock:text"..msg.chat_id_) and not Vips(msg) then       
Delete_Message(msg.chat_id_,{[0] = msg.id_})   
return false     
end     
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then 
redis:incr('GLOBLA:'..bot_id.."Num:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) 
end
if msg.content_.ID == "MessageChatAddMembers" and not Vips(msg) then   
if redis:get('GLOBLA:'..bot_id.."Status:Lock:AddMempar"..msg.chat_id_) == "kick" then
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Join"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
return false  
end
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:User:Name"..msg.chat_id_) == "del" and not Vips(msg) then    
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:User:Name"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:User:Name"..msg.chat_id_) == "kick" and not Vips(msg) then    
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:User:Name"..msg.chat_id_) == "ktm" and not Vips(msg) then    
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("#[%a%d_]+") or msg.content_.caption_:match("#(.+)") then 
if redis:get('GLOBLA:'..bot_id.."Status:Lock:hashtak"..msg.chat_id_) == "del" and not Vips(msg) then    
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:hashtak"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:hashtak"..msg.chat_id_) == "kick" and not Vips(msg) then    
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:hashtak"..msg.chat_id_) == "ktm" and not Vips(msg) then    
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if msg.content_.caption_ then 
if msg.content_.caption_:match("/[%a%d_]+") or msg.content_.caption_:match("/(.+)") then  
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Cmd"..msg.chat_id_) == "del" and not Vips(msg) then    
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Cmd"..msg.chat_id_) == "ked" and not Vips(msg) then    
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Cmd"..msg.chat_id_) == "kick" and not Vips(msg) then    
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Cmd"..msg.chat_id_) == "ktm" and not Vips(msg) then    
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Link"..msg.chat_id_) == "del" and not Vips(msg) then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Link"..msg.chat_id_) == "ked" and not Vips(msg) then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Link"..msg.chat_id_) == "kick" and not Vips(msg) then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Link"..msg.chat_id_) == "ktm" and not Vips(msg) then
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Photo"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Photo"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Photo"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Photo"..msg.chat_id_) == "ktm" then
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Video"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Video"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Video"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Video"..msg.chat_id_) == "ktm" then
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Animation"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Animation"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Animation"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Animation"..msg.chat_id_) == "ktm" then
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:geam"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:geam"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:geam"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:geam"..msg.chat_id_) == "ktm" then
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Audio"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Audio"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Audio"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Audio"..msg.chat_id_) == "ktm" then
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:vico"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:vico"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:vico"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:vico"..msg.chat_id_) == "ktm" then
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Keyboard"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Keyboard"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Keyboard"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Keyboard"..msg.chat_id_) == "ktm" then
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Sticker"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Sticker"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Sticker"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Sticker"..msg.chat_id_) == "ktm" then
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:forward"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:forward"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:forward"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
return false
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:forward"..msg.chat_id_) == "ktm" then
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
return false
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Document"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Document"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Document"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Document"..msg.chat_id_) == "ktm" then
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Unsupported"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Unsupported"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Unsupported"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Unsupported"..msg.chat_id_) == "ktm" then
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
if not Vips(msg) then
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Markdaun"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Markdaun"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Markdaun"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Markdaun"..msg.chat_id_) == "ktm" then
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end  
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Inlen"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Inlen"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Inlen"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Inlen"..msg.chat_id_) == "ktm" then
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end 
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Contact"..msg.chat_id_) == "del" then
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Contact"..msg.chat_id_) == "ked" then
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Contact"..msg.chat_id_) == "kick" then
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Contact"..msg.chat_id_) == "ktm" then
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
...
sens = 400  
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Spam"..msg.chat_id_) == "del" and not Vips(msg) and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Spam"..msg.chat_id_) == "ked" and not Vips(msg) and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
RestrictChat(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Spam"..msg.chat_id_) == "kick" and not Vips(msg) and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
KickGroup(msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Spam"..msg.chat_id_) == "ktm" and not Vips(msg) and string.len(msg.content_.text_) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_)
Delete_Message(msg.chat_id_,{[0] = msg.id_}) 
end
end
if text and redis:get('GLOBLA:'..bot_id..'Status:lock:Fsh'..msg.chat_id_) and not Vips(msg) then
...
if text and redis:get('GLOBLA:'..bot_id..'Status:lock:Far'..msg.chat_id_) and not Vips(msg) then
...
if tonumber(msg.sender_user_id_) == tonumber(1056550431) then
send(msg.chat_id_, msg.id_,'هلا حبيبي وتجراسي العالمي .')
return false 
end
if redis:get('GLOBLA:'..bot_id.."Status:lock:kanser"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
local last_ = data.last_name_ or ''
local first_ = data.first_name_ or ''
local zain = (first_..''..last_)
local Num = (redis:get('GLOBLA:'..bot_id..'Num:kansers'..msg.chat_id_) or 25)
if string.len(zain) > tonumber(Num) then
send(msg.chat_id_, msg.id_,'\n⌔︙الكانسر مقفول يرجى زغرفه اسمك اولاً\n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉\n[⌔︙ اضغط هنا لزغرفه اسمك.](https://t.me/ZAKRF3BOT)')
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..msg.sender_user_id_)
end
end,nil)   
return false
...
if status_welcome and not redis:get('GLOBLA:'..bot_id.."Status:Lock:tagservr"..msg.chat_id_) then
...
redis:set('GLOBLA:'..bot_id.."Get:Id:Msg:Pin"..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = redis:get('GLOBLA:'..bot_id.."Get:Id:Msg:Pin"..msg.chat_id_)
if Msg_Pin and redis:get('GLOBLA:'..bot_id.."Status:lockpin"..msg.chat_id_) then
Pin_Message(msg.chat_id_,Msg_Pin)
end
end
end
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID ~= "MessageChatAddMembers" and redis:hget('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_,"Spam:User") and not Vips(msg) then 
if msg.sender_user_id_ ~= bot_id and not Vips(msg)  then
floods = redis:hget('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = redis:hget('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = redis:hget('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(redis:get('GLOBLA:'..bot_id.."Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(redis:hget('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = redis:hget('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
redis:setex('GLOBLA:'..bot_id.."Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(redis:hget('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if redis:hget('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = redis:hget('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if redis:hget('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = redis:hget('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--------------------------------------------------------------------------------------------------------------
if msg.content_.photo_ then  
if redis:get('GLOBLA:'..bot_id.."Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) then 
...
redis:del('GLOBLA:'..bot_id.."Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
...
------------------------------------------------------------------------------------------------------------
if redis:get('GLOBLA:'..bot_id.."Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n⌔︙تم الغاء الاذاعه للمجموعات") 
redis:del('GLOBLA:'..bot_id.."Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
...
------------------------------------------------------------------------------------------------------------
if redis:get('GLOBLA:'..bot_id.."Broadcasting:Users" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n⌔︙تم الغاء الاذاعه خاص") 
redis:del('GLOBLA:'..bot_id.."Broadcasting:Users" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
...
------------------------------------------------------------------------------------------------------------
if redis:get('GLOBLA:'..bot_id.."Broadcasting:Groups" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n⌔︙تم الغاء الاذاعه للمجموعات") 
redis:del('GLOBLA:'..bot_id.."Broadcasting:Groups" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end 
local list = redis:smembers('GLOBLA:'..bot_id.."Groups_Users") 
send(msg.chat_id_, msg.id_,"⌔︙تمت الاذاعه الى *- "..#list.." * مجموعه في البوت ")     
...
------------------------------------------------------------------------------------------------------------
if redis:get('GLOBLA:'..bot_id.."Broadcasting:Groups:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n⌔︙تم الغاء الاذاعه بالتوجيه للمجموعات") 
redis:del('GLOBLA:'..bot_id.."Broadcasting:Groups:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
...
------------------------------------------------------------------------------------------------------------
if redis:get('GLOBLA:'..bot_id.."Broadcasting:Users:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n⌔︙تم الغاء الاذاعه بالترجيه خاص") 
redis:del('GLOBLA:'..bot_id.."Broadcasting:Users:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = redis:smembers('GLOBLA:'..bot_id.."Users:ids")   
...
------------------------------------------------------------------------------------------------------------
if redis:get('GLOBLA:'..bot_id.."Change:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text == "الغاء" then 
send(msg.chat_id_,msg.id_, "\n⌔︙تم الغاء امر تغير وصف المجموعه") 
redis:del('GLOBLA:'..bot_id.."Change:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
redis:del('GLOBLA:'..bot_id.."Change:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
--------------------------------------------------------------------------------------------------------------
if redis:get('GLOBLA:'..bot_id.."Status:link:set"..msg.chat_id_..""..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_, "\n⌔︙تم الغاء امر حفظ الرابط") 
redis:del('GLOBLA:'..bot_id.."Status:link:set"..msg.chat_id_..""..msg.sender_user_id_) 
return false
end
...
local Text_Filter = redis:get('GLOBLA:'..bot_id.."Filter:Reply2"..text..msg.chat_id_)   
if Text_Filter then    
...
------------------------------------------------------------------------------------------------------------
if redis:get('GLOBLA:'..bot_id.."Change:Name:Bot"..msg.sender_user_id_) then 
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n⌔︙تم الغاء امر تغير اسم البوت") 
redis:del('GLOBLA:'..bot_id.."Change:Name:Bot"..msg.sender_user_id_) 
return false  
end 
redis:del('GLOBLA:'..bot_id.."Change:Name:Bot"..msg.sender_user_id_) 
redis:set('GLOBLA:'..bot_id.."Redis:Name:Bot",text) 
Name_Bot = text
send(msg.chat_id_, msg.id_, "⌔︙ تم تغير اسم البوت الى - "..text)  
return false
end 
------------------------------------------------------------------------------------------------------------
if redis:get('GLOBLA:'..bot_id.."Redis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_,msg.id_, "\n⌔︙تم الغاء امر اضافة صلاحيه") 
local CmdDel = redis:get('GLOBLA:'..bot_id.."Add:Validity:Group:Rt:New"..msg.chat_id_..msg.sender_user_id_)  
redis:del('GLOBLA:'..bot_id.."Add:Validity:Group:Rt"..CmdDel..msg.chat_id_)
redis:srem('GLOBLA:'..bot_id.."Validitys:Group"..msg.chat_id_,CmdDel)  
redis:del('GLOBLA:'..bot_id.."Redis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 

if text == "مدير" or text == "ادمن" or text == "مميز" or text == "عضو" then
local textn = redis:get('GLOBLA:'..bot_id.."Add:Validity:Group:Rt:New"..msg.chat_id_..msg.sender_user_id_)  
redis:set('GLOBLA:'..bot_id.."Add:Validity:Group:Rt"..textn..msg.chat_id_,text)
...
------------------------------------------------------------------------------------------------------------
if redis:get('GLOBLA:'..bot_id.."Redis:Id:Group"..msg.chat_id_..""..msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_,msg.id_, "\n⌔︙تم الغاء امر تعين الايدي") 
redis:del('GLOBLA:'..bot_id.."Redis:Id:Group"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
redis:del('GLOBLA:'..bot_id.."Redis:Id:Group"..msg.chat_id_..""..msg.sender_user_id_) 
redis:set('GLOBLA:'..bot_id.."Set:Id:Group"..msg.chat_id_,text:match("(.*)"))
send(msg.chat_id_, msg.id_,'⌔︙تم تعين الايدي الجديد')    
end
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get('GLOBLA:'..bot_id.."Status:Random:Sm"..msg.chat_id_) or "").."" and not redis:get('GLOBLA:'..bot_id.."Status:Set:Sma"..msg.chat_id_) then
if not redis:get('GLOBLA:'..bot_id.."Status:Set:Sma"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"\n⌔︙لقد فزت في اللعبه \n⌔︙اللعب مره اخره وارسل - سمايل او سمايلات")
redis:incrby('GLOBLA:'..bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set('GLOBLA:'..bot_id.."Status:Set:Sma"..msg.chat_id_,true)
return false
end 
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get('GLOBLA:'..bot_id.."Status:Klam:Speed"..msg.chat_id_) or "").."" and not redis:get('GLOBLA:'..bot_id.."Status:Speed:Tr"..msg.chat_id_) then
if not redis:get('GLOBLA:'..bot_id.."Status:Speed:Tr"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"\n⌔︙لقد فزت في اللعبه \n⌔︙اللعب مره اخره وارسل - الاسرع او ترتيب")
redis:incrby('GLOBLA:'..bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set('GLOBLA:'..bot_id.."Status:Speed:Tr"..msg.chat_id_,true)
end 
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get('GLOBLA:'..bot_id.."Status:Klam:Hzor"..msg.chat_id_) or "").."" and not redis:get('GLOBLA:'..bot_id.."Status:Set:Hzora"..msg.chat_id_) then
if not redis:get('GLOBLA:'..bot_id.."Status:Set:Hzora"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"\n⌔︙لقد فزت في اللعبه \n⌔︙اللعب مره اخره وارسل - حزوره")
redis:incrby('GLOBLA:'..bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set('GLOBLA:'..bot_id.."Status:Set:Hzora"..msg.chat_id_,true)
end 
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get('GLOBLA:'..bot_id.."Status:Maany"..msg.chat_id_) or "").."" and not redis:get('GLOBLA:'..bot_id.."Status:Set:Maany"..msg.chat_id_) then
if not redis:get('GLOBLA:'..bot_id.."Status:Set:Maany"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"\n⌔︙لقد فزت في اللعبه \n⌔︙اللعب مره اخره وارسل - معاني")
redis:incrby('GLOBLA:'..bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set('GLOBLA:'..bot_id.."Status:Set:Maany"..msg.chat_id_,true)
end 
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get('GLOBLA:'..bot_id.."Status:Set:Aks:Game"..msg.chat_id_) or "").."" and not redis:get('GLOBLA:'..bot_id.."Status:Set:Aks"..msg.chat_id_) then
if not redis:get('GLOBLA:'..bot_id.."Status:Set:Aks"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,"\n⌔︙لقد فزت في اللعبه \n⌔︙اللعب مره اخره وارسل - العكس")
redis:incrby('GLOBLA:'..bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set('GLOBLA:'..bot_id.."Status:Set:Aks"..msg.chat_id_,true)
end 
------------------------------------------------------------------------------------------------------------
if redis:get('GLOBLA:'..bot_id.."Status:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
send(msg.chat_id_, msg.id_,"⌔︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
local GETNUM = redis:get('GLOBLA:'..bot_id.."Status:GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del('GLOBLA:'..bot_id.."Status:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
redis:del('GLOBLA:'..bot_id.."Status:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
redis:incrby('GLOBLA:'..bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_,5)  
send(msg.chat_id_, msg.id_,"⌔︙مبروك فزت ويانه وخمنت الرقم الصحيح\n⌔︙تم اضافة { 5 } من النقاط \n")
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:incrby('GLOBLA:'..bot_id.."Status:SADD:NUM"..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(redis:get('GLOBLA:'..bot_id.."Status:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)) >= 3 then
redis:del('GLOBLA:'..bot_id.."Status:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
redis:del('GLOBLA:'..bot_id.."Status:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
------------------------------------------------------------------------------------------------------------
if redis:get('GLOBLA:'..bot_id.."Status:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
send(msg.chat_id_, msg.id_,"⌔︙عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
local GETNUM = redis:get('GLOBLA:'..bot_id.."Status:Games:Bat"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del('GLOBLA:'..bot_id.."Status:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,"⌔︙مبروك فزت وطلعت المحيبس بل ايد رقم { "..NUM.." }\n⌔︙لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ")
redis:incrby('GLOBLA:'..bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:del('GLOBLA:'..bot_id.."Status:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get('GLOBLA:'..bot_id.."Status::Set:Moktlf"..msg.chat_id_) or "").."" then 
if not redis:get('GLOBLA:'..bot_id.."Status:Set:Moktlf:Bot"..msg.chat_id_) then 
redis:del('GLOBLA:'..bot_id.."Status::Set:Moktlf"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"\n⌔︙لقد فزت في اللعبه \n⌔︙اللعب مره اخره وارسل - المختلف")
redis:incrby('GLOBLA:'..bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set('GLOBLA:'..bot_id.."Status:Set:Moktlf:Bot"..msg.chat_id_,true)
end
------------------------------------------------------------------------------------------------------------
if text == ""..(redis:get('GLOBLA:'..bot_id.."Status:Set:Amth"..msg.chat_id_) or "").."" then 
if not redis:get('GLOBLA:'..bot_id.."Status:Set:Amth:Bot"..msg.chat_id_) then 
redis:del('GLOBLA:'..bot_id.."Status:Set:Amth"..msg.chat_id_)
send(msg.chat_id_, msg.id_,"\n⌔︙لقد فزت في اللعبه \n⌔︙اللعب مره اخره وارسل - امثله")
redis:incrby('GLOBLA:'..bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
redis:set('GLOBLA:'..bot_id.."Status:Set:Amth:Bot"..msg.chat_id_,true)
end
------------------------------------------------------------------------------------------------------------
if redis:get('GLOBLA:'..bot_id.."Status:Add:msg:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
redis:del('GLOBLA:'..bot_id.."id:user"..msg.chat_id_)  
send(msg.chat_id_,msg.id_, "\n⌔︙تم الغاء امر اضافة رسائل") 
redis:del('GLOBLA:'..bot_id.."Status:Add:msg:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
redis:del('GLOBLA:'..bot_id.."Status:Add:msg:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
...
redis:incrby('GLOBLA:'..bot_id.."Num:Message:Userr"..msg.chat_id_..":"..iduserr,numadded)  
send(msg.chat_id_,msg.id_,"\n⌔︙تم اضافة له - "..numadded.." رسائل")  
end
------------------------------------------------------------------------------------------------------------
if redis:get('GLOBLA:'..bot_id.."Status:games:add" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
redis:del('GLOBLA:'..bot_id.."idgem:user"..msg.chat_id_)  
send(msg.chat_id_,msg.id_, "\n⌔︙تم الغاء امر اضافة جواهر") 
redis:del('GLOBLA:'..bot_id.."Status:games:add" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
redis:del('GLOBLA:'..bot_id.."Status:games:add" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = redis:get('GLOBLA:'..bot_id.."idgem:user"..msg.chat_id_)  
redis:incrby('GLOBLA:'..bot_id.."Num:Add:Games"..msg.chat_id_..iduserr,numadded)  
send(msg.chat_id_,msg.id_,"\n⌔︙تم اضافة له - "..numadded.." مجوهرات")  
end
------------------------------------------------------------------------------------------------------------
if redis:get('GLOBLA:'..bot_id.."Redis:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == "الغاء" then 
send(msg.chat_id_, msg.id_, "⌔︙تم الغاء حفظ القوانين") 
redis:del('GLOBLA:'..bot_id.."Redis:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
redis:set('GLOBLA:'..bot_id..":Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"⌔︙تم حفظ قوانين المجموعه") 
redis:del('GLOBLA:'..bot_id.."Redis:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
------------------------------------------------------------------------------------------------------------
if text then 
local DelFilter = redis:get('GLOBLA:'..bot_id.."Filter:Reply1"..msg.sender_user_id_..msg.chat_id_)  
if DelFilter and DelFilter == "DelFilter" then   
send(msg.chat_id_, msg.id_,"⌔︙تم الغاء منعها ")  
redis:del('GLOBLA:'..bot_id.."Filter:Reply1"..msg.sender_user_id_..msg.chat_id_)  
redis:del('GLOBLA:'..bot_id.."Filter:Reply2"..text..msg.chat_id_)  
redis:srem('GLOBLA:'..bot_id.."List:Filter"..msg.chat_id_,text)  
return false  end  
end
------------------------------------------------------------------------------------------------------------
if text then   
local SetFilter = redis:get('GLOBLA:'..bot_id.."Filter:Reply1"..msg.sender_user_id_..msg.chat_id_)  
if SetFilter and SetFilter == "SetFilter" then   
send(msg.chat_id_, msg.id_,"⌔︙ارسل التحذير عند ارسال الكلمه")  
redis:set('GLOBLA:'..bot_id.."Filter:Reply1"..msg.sender_user_id_..msg.chat_id_,"WirngFilter")  
redis:set('GLOBLA:'..bot_id.."Filter:Reply:Status"..msg.sender_user_id_..msg.chat_id_, text)  
...
------------------------------------------------------------------------------------------------------------
if text then  
local WirngFilter = redis:get('GLOBLA:'..bot_id.."Filter:Reply1"..msg.sender_user_id_..msg.chat_id_)  
if WirngFilter and WirngFilter == "WirngFilter" then  
send(msg.chat_id_, msg.id_,"⌔︙تم منع الكلمه مع التحذير")  
redis:del('GLOBLA:'..bot_id.."Filter:Reply1"..msg.sender_user_id_..msg.chat_id_)  
local test = redis:get('GLOBLA:'..bot_id.."Filter:Reply:Status"..msg.sender_user_id_..msg.chat_id_)  
if text then   
redis:set('GLOBLA:'..bot_id.."Filter:Reply2"..test..msg.chat_id_, text)  
end  
redis:del('GLOBLA:'..bot_id.."Filter:Reply:Status"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
------------------------------------------------------------------------------------------------------------
if text and redis:get('GLOBLA:'..bot_id..'GetTexting:DevGLOBLA'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' or text == 'الغاء ✖' then 
redis:del('GLOBLA:'..bot_id..'GetTexting:DevGLOBLA'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'⌔︙تم الغاء حفظ كليشة المطور')
return false
end
redis:set('GLOBLA:'..bot_id..'Texting:DevGLOBLA',text)
redis:del('GLOBLA:'..bot_id..'GetTexting:DevGLOBLA'..msg.chat_id_..':'..msg.sender_user_id_)
...
------------------------------------------------------------------------------------------------------------
if text and not redis:get('GLOBLA:'..bot_id.."Status:Reply:Manager"..msg.chat_id_) then
if not redis:sismember('GLOBLA:'..bot_id..'Spam_For_Bot'..msg.sender_user_id_,text) then
...
local Text = redis:get('GLOBLA:'..bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
local NumMsgg = redis:get('GLOBLA:'..bot_id..'Num:Message:Userr'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local NumMsg =( redis:get('GLOBLA:'..bot_id..'Num:Message:User'..msg.chat_id_..':'..msg.sender_user_id_) or 0 + NumMsgg)
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(msg.sender_user_id_,msg.chat_id_)
local NumMessageEdit = redis:get('GLOBLA:'..bot_id..'Num:Message:Edit'..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_,'['..Text..']')
redis:sadd('GLOBLA:'..bot_id.."Spam_For_Bot"..msg.sender_user_id_,text) 
end,nil)
end
if stekr then 
...
local Users = redis:smembers('GLOBLA:'..bot_id.."GLOBLA:UsersBot")
local Groups = redis:smembers('GLOBLA:'..bot_id..'GLOBLA:Chek:Groups') 
for i = 1, #Groups do
redis:sadd('GLOBLA:'..bot_id..'Groups_Users',Groups[i])  
local list1 = redis:smembers('GLOBLA:'..bot_id..'GLOBLA:Basic:Constructor'..Groups[i])
for k,v in pairs(list1) do
redis:sadd('GLOBLA:'..bot_id.."President:User"..Groups[i], v)
end
local list2 = redis:smembers('GLOBLA:'..bot_id..'GLOBLA:Constructor'..Groups[i])
for k,v in pairs(list2) do
redis:sadd('GLOBLA:'..bot_id.."Constructor:Group"..Groups[i], v)
end
local list3 = redis:smembers('GLOBLA:'..bot_id..'GLOBLA:Manager'..Groups[i])
for k,v in pairs(list3) do
redis:sadd('GLOBLA:'..bot_id.."Manager:Group"..Groups[i], v)
end
local list4 = redis:smembers('GLOBLA:'..bot_id..'GLOBLA:Mod:User'..Groups[i])
for k,v in pairs(list4) do
redis:sadd('GLOBLA:'..bot_id.."Admin:Group"..Groups[i], v)
end
redis:set('GLOBLA:'..bot_id.."Status:Lock:tagservrbot"..Groups[i],true)   
list ={"Status:Lock:Bot:kick","Status:Lock:User:Name","Status:Lock:hashtak","Status:Lock:Cmd","Status:Lock:Link","Status:Lock:forward","Status:Lock:Keyboard","Status:Lock:geam","Status:Lock:Photo","Status:Lock:Animation","Status:Lock:Video","Status:Lock:Audio","Status:Lock:vico","Status:Lock:Sticker","Status:Lock:Document","Status:Lock:Unsupported","Status:Lock:Markdaun","Status:Lock:Contact","Status:Status:Lock:Spam"}
for i,lock in pairs(list) do
redis:set('GLOBLA:'..bot_id..lock..Groups[i],"del")
end
end
for i = 1, #Users do
...
download_to_file('https://raw.githubusercontent.com/TeamGLOBLA/GLOBLA/master/GLOBLA.lua','GLOBLA.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/DevGLOBLA/Files_GLOBLA/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
if Get_info then
local TextS = "\n⌔︙قائمه ملفات متجر سورس GLOBLA\n⌔︙الملفات المتوفره حاليا\n━━━━━━━━━━━━━\n\n"
...
local Get_Json, Res = https.request("https://raw.githubusercontent.com/DevGLOBLA/Files_GLOBLA/master/Files_GLOBLA/"..File_Name)
if Res == 200 then
...
------------------------------------------------------------------------------------------------------------
if text and not redis:get('GLOBLA:'..bot_id.."Status:Reply:Sudo"..msg.chat_id_) then
if not redis:sismember('GLOBLA:'..bot_id..'Spam_For_Bot'..msg.sender_user_id_,text) then
...
local Text = redis:get('GLOBLA:'..bot_id.."Add:Rd:Sudo:Text"..text)   
...
------------------------------------------------------------------------------------------------------------
if text and redis:get('GLOBLA:'..bot_id..'Set:Cmd:Start:Bot') then
if text == 'الغاء ✖' then   
send(msg.chat_id_, msg.id_,"⌔︙تم الغاء حفظ كليشه امر /start") 
redis:del('GLOBLA:'..bot_id..'Set:Cmd:Start:Bot') 
return false
end
redis:set('GLOBLA:'..bot_id.."Set:Cmd:Start:Bot",text)  
...
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
if Sudo_Id(msg) then
...
if not redis:get('GLOBLA:'..bot_id..'Ban:Cmd:Start'..msg.sender_user_id_) then
local GetCmdStart = redis:get('GLOBLA:'..bot_id.."Set:Cmd:Start:Bot")  
...
redis:setex('GLOBLA:'..bot_id..'Ban:Cmd:Start'..msg.sender_user_id_,60,true)
return false
end
if not Sudo_Id(msg) and not redis:sismember('GLOBLA:'..bot_id..'User:Ban:Pv',msg.sender_user_id_) and not redis:get('GLOBLA:'..bot_id..'Status:Lock:Twasl') then
send(msg.sender_user_id_,msg.id_,'⌔︙تم ارسال رسالتك الى المطور ← { ['..UserName..'] }')    
local List_id = {SUDO,msg.sender_user_id_}
...
Send_Optionspv(SUDO,0,msg.sender_user_id_,"reply_Pv","⌔︙قام بارسال الملصق")  
return false
end
end
end,nil)
...
if text == 'حظر' then
Send_Optionspv(SUDO,msg.id_,UserForward,"reply_Pv","⌔︙تم حظره من تواصل البوت")  
redis:sadd('GLOBLA:'..bot_id..'User:Ban:Pv',data.id_)  
return false  
elseif text =='الغاء الحظر' then
Send_Optionspv(SUDO,msg.id_,UserForward,"reply_Pv","⌔︙تم الغاء حظره من تواصل البوت")  
redis:srem('GLOBLA:'..bot_id..'User:Ban:Pv',data.id_)  
return false  
end 
...
Send_Optionspv(SUDO,msg.id_,UserForward,"reply_Pv","⌔︙قام بحظر البوت لا تستطيع ارسال له رسائل")  
return false  
end 
if text then    
...
Send_Optionspv(SUDO,msg.id_,UserForward,"reply_Pv","⌔︙تم ارسال رسالتك اليه بنجاح")  
end,nil)end,nil)
end
if text == 'تغير كليشه ستارت 🆕' then
redis:set('GLOBLA:'..bot_id..'Set:Cmd:Start:Bot',true) 
...
redis:setex('GLOBLA:'..bot_id.."Broadcasting:Groups" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⌔︙ارسل لي المنشور الان\n⌔︙يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n⌔︙لالغاء الاذاعه ارسل : الغاء") 
return false
elseif text=="اذاعه بالتثبيت 📌" and DeveloperBot(msg) then 
redis:setex('GLOBLA:'..bot_id.."Broadcasting:Groups:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⌔︙ارسل لي المنشور الان\n⌔︙يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n⌔︙لالغاء الاذاعه ارسل : الغاء") 
return false
elseif text=="اذاعه بالتوجيه 👥" and DeveloperBot(msg) then 
redis:setex('GLOBLA:'..bot_id.."Broadcasting:Groups:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⌔︙ارسل لي التوجيه الان\n⌔︙ليتم نشره في المجموعات") 
return false
elseif text=="اذاعه خاص بالتوجيه 👤" and DeveloperBot(msg) then 
redis:setex('GLOBLA:'..bot_id.."Broadcasting:Users:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"⌔︙ارسل لي التوجيه الان\n⌔︙ليتم نشره الى المشتركين") 
return false
elseif text == 'ازالة كليشة المطور 🆗' then
redis:del('GLOBLA:'..bot_id..'Texting:DevGLOBLA')
send(msg.chat_id_, msg.id_,'⌔︙ تم حذف كليشه المطور')
elseif text == "تغير اسم البوت 🔄" then 
redis:setex('GLOBLA:'..bot_id.."Change:Name:Bot"..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"⌔︙ ارسل لي الاسم الان ")  
return false
elseif text == ("مسح قائمه العام 💯") or text == ("مسح المحظورين عام") then
redis:del('GLOBLA:'..bot_id.."Removal:User:Groups")
send(msg.chat_id_, msg.id_, "⌔︙تم مسح المحظورين عام من البوت")
elseif text == ("مسح قائمه المطورين 🚫") then
redis:del('GLOBLA:'..bot_id.."Developer:Bot")
send(msg.chat_id_, msg.id_, "⌔︙ تم مسح المطورين من البوت  ")
elseif text == ("قائمه العام 📝") or text == ("المحظورين عام") then
local list = redis:smembers('GLOBLA:'..bot_id.."Removal:User:Groups")
Gban = "\n⌔︙قائمة المحظورين عام في البوت\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = redis:get('GLOBLA:'..bot_id.."Save:Username" .. v)
if username then
...
local list = redis:smembers('GLOBLA:'..bot_id.."Developer:Bot")
...
if Sudo_Id_User(result.id_) == true then
send(msg.chat_id_, msg.id_, "⌔︙لا تستطيع حظر المطور الاساسي عام")
return false 
end
redis:sadd('GLOBLA:'..bot_id.."Removal:User:Groups", result.id_)
...
redis:srem('GLOBLA:'..bot_id.."Removal:User:Groups", result.id_)
else
send(msg.chat_id_, msg.id_,"⌔︙المعرف غلط ")
end
end
...
redis:sadd('GLOBLA:'..bot_id.."Developer:Bot", result.id_)
...
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem('GLOBLA:'..bot_id.."Developer:Bot", result.id_)
...
send(msg.chat_id_, msg.id_,'*⌔︙عدد احصائيات البوت الكامله \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n⌔︙عدد المجموعات : '..(redis:scard('GLOBLA:'..bot_id..'Groups_Users') or 0)..'\n⌔︙عدد المشتركين : '..(redis:scard('GLOBLA:'..bot_id..'Users:ids') or 0)..'*')
elseif text and text:match("^تعين عدد الاعضاء (%d+)$") then
redis:set('GLOBLA:'..bot_id..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local Groups = redis:smembers('GLOBLA:'..bot_id..'Groups_Users')  
local Get_Json = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(Groups) do   
local President = redis:smembers('GLOBLA:'..bot_id.."President:User"..v)
local BasicBuilder = redis:smembers('GLOBLA:'..bot_id.."Basic:User"..v)
...
local Admin = redis:smembers('GLOBLA:'..bot_id.."Admin:Group"..v)
local Vips = redis:smembers('GLOBLA:'..bot_id.."Vip:Group"..v)
local LinkGroup = redis:get('GLOBLA:'..bot_id.."Private:Group:Link"..v) 
...
local Status_Prt = redis:get('GLOBLA:'..bot_id.."President:User:Reply"..v) 
local Status_Prx = redis:get('GLOBLA:'..bot_id.."Basic:User:Reply"..v) 
...
local Status_Md = redis:get('GLOBLA:'..bot_id.."Admin:Group:Reply"..v) 
local Status_Vip = redis:get('GLOBLA:'..bot_id.."Vip:Group:Reply"..v) 
...
if #BasicBuilder ~= 0 then 
Get_Json = Get_Json..'"BasicBuilder":['
for k,v in pairs(BasicBuilder) do
if k == 1 then
Get_Json = Get_Json..'"'..v..'"'
else
Get_Json = Get_Json..',"'..v..'"'
...
redis:del('GLOBLA:'..bot_id..'Status:Lock:Twasl') 
send(msg.chat_id_, msg.id_,'⌔︙ تم تفعيل التواصل ') 
elseif text == 'تعطيل تواصل البوت 🔕' then  
redis:set('GLOBLA:'..bot_id..'Status:Lock:Twasl',true) 
send(msg.chat_id_, msg.id_,'⌔︙ تم تعطيل التواصل ') 
end
end 
end
if TypeForChat == ("ForSuppur") then
if text ==  ""..Name_Bot..' شنو رئيك بهاذا' and tonumber(msg.reply_to_message_id_) > 0 and not redis:get('GLOBLA:'..bot_id.."Status:Fun:Bots"..msg.chat_id_) then     
...
return false
elseif text == ""..Name_Bot..' شنو رئيك بهاي' and tonumber(msg.reply_to_message_id_) > 0 and not redis:get('GLOBLA:'..bot_id.."Status:Fun:Bots"..msg.chat_id_) then    
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)},function(Arg, Data) 
...
if text == 'رفع النسخه الاحتياطيه' and tonumber(msg.reply_to_message_id_) > 0 and Sudo_Id(msg) then   
tdcli_function({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},function(Arg, Data)   
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Sudo_Id(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
function FunctionStatus(arg, result)
redis:sadd('GLOBLA:'..bot_id.."Developer:Bot", result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","⌔︙تم ترقيته مطور في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
return false
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Sudo_Id(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
function FunctionStatus(arg, result)
redis:srem('GLOBLA:'..bot_id.."Developer:Bot", result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","⌔︙تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
return false
end
if text and text:match("^اضف مطور @(.*)$") and Sudo_Id(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
...
if text and text:match("^حذف مطور @(.*)$") and Sudo_Id(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
...
if text and text:match("^اضف مطور (%d+)$") and Sudo_Id(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
redis:sadd('GLOBLA:'..bot_id.."Developer:Bot", text:match("^اضف مطور (%d+)$"))
Send_Options(msg,text:match("^اضف مطور (%d+)$"),"reply","⌔︙تم ترقيته مطور في البوت")  
return false
end
if text and text:match("^حذف مطور (%d+)$") and Sudo_Id(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
redis:srem('GLOBLA:'..bot_id.."Developer:Bot", text:match("^حذف مطور (%d+)$"))
Send_Options(msg,text:match("^حذف مطور (%d+)$"),"reply","⌔︙تم تنزيله من المطورين")  
return false
end
if text == 'جلب نسخه احتياطيه' and Sudo_Id(msg) or text == 'جلب نسخه الكروبات' and Sudo_Id(msg) then
local list = redis:smembers('GLOBLA:'..bot_id..'Groups_Users')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'GLOBLA Chat'
MALK = redis:smembers('GLOBLA:'..bot_id.."President:User"..v)
ASAS = redis:smembers('GLOBLA:'..bot_id.."BasicBuilder"..v)
MNSH = redis:smembers('GLOBLA:'..bot_id.."Constructor:Group"..v)
MDER = redis:smembers('GLOBLA:'..bot_id.."Manager:Group"..v)
MOD = redis:smembers('GLOBLA:'..bot_id.."Admin:Group"..v)
link = redis:get('GLOBLA:'..bot_id.."Private:Group:Link"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"tek":"'..NAME..'",'
else
t = t..',"'..v..'":{"tek":"'..NAME..'",'
...
redis:del('GLOBLA:'..bot_id..'Basic:User'..msg.chat_id_)
redis:del('GLOBLA:'..bot_id..'Constructor:Group'..msg.chat_id_)
redis:del('GLOBLA:'..bot_id..'Manager:Group'..msg.chat_id_)
redis:del('GLOBLA:'..bot_id..'Admin:Group'..msg.chat_id_)
redis:del('GLOBLA:'..bot_id..'Vip:Group'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'⌔︙تم تنزيل الكل من جميع الرتب\n{الاساسين، المنشئين ، المدراء ، الادمنيه ، المميزين}')  
end
if text == ("مسح قائمه العام") and Sudo_Id(msg) or text == ("مسح المحظورين عام") and Sudo_Id(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
redis:del('GLOBLA:'..bot_id.."Removal:User:Groups")
send(msg.chat_id_, msg.id_, "⌔︙تم مسح المحظورين عام من البوت")
elseif text == ("مسح المطورين") and Sudo_Id(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
...
local list = redis:smembers('GLOBLA:'..bot_id.."Keed:User:Group"..msg.chat_id_)
...
redis:del('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_)
...
redis:del('GLOBLA:'..bot_id.."Keed:User:Group"..msg.chat_id_)
...
redis:del('GLOBLA:'..bot_id.."Removal:User:Group"..msg.chat_id_)
...
local list = redis:smembers('GLOBLA:'..bot_id.."Validitys:Group"..msg.chat_id_)
for k,v in pairs(list) do;redis:del('GLOBLA:'..bot_id.."Add:Validity:Group:Rt"..v..msg.chat_id_);redis:del('GLOBLA:'..bot_id.."Validitys:Group"..msg.chat_id_);end
send(msg.chat_id_, msg.id_,"⌔︙تم مسح صلاحيات المجموعه")
elseif text == ("قائمه العام") and Sudo_Id(msg) or text == ("المحظورين عام") and Sudo_Id(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
...
send(msg.chat_id_, msg.id_, Gban)
elseif text == ("المطورين") and Sudo_Id(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
...
local list = redis:smembers('GLOBLA:'..bot_id.."Basic:User"..msg.chat_id_)
...
local list = redis:smembers('GLOBLA:'..bot_id.."Constructor:Group"..msg.chat_id_)
...
local list = redis:smembers('GLOBLA:'..bot_id.."Manager:Group"..msg.chat_id_)
...
local list = redis:smembers('GLOBLA:'..bot_id.."Admin:Group"..msg.chat_id_)
...
local list = redis:smembers('GLOBLA:'..bot_id.."Vip:Group"..msg.chat_id_)
...
local list = redis:smembers('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_)
...
local list = redis:smembers('GLOBLA:'..bot_id.."Removal:User:Group"..msg.chat_id_)
...
for k,v in pairs(list) do
var = redis:get('GLOBLA:'..bot_id.."Add:Validity:Group:Rt"..v..msg.chat_id_)
if var then
...
for k, v in pairs(list) do
x = x + 1
if redis:get('GLOBLA:'..bot_id.."Save:Username"..v.user_id_) then
t = t..""..x.." : [@"..redis:get('GLOBLA:'..bot_id.."Save:Username"..v.user_id_).."]\n"
else
t = t..""..x.." : "..v.user_id_.."\n"
end
end
...
elseif text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and Sudo_Id(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
...
if Sudo_Id_User(result.sender_user_id_) == true then
send(msg.chat_id_, msg.id_, "⌔︙لا تستطيع حظر المطور الاساسي عام")
return false 
end
Send_Options(msg,result.sender_user_id_,"reply","⌔︙تم حظره عام من المجموعات")  
redis:sadd('GLOBLA:'..bot_id.."Removal:User:Groups", result.sender_user_id_)
KickGroup(result.chat_id_, result.sender_user_id_)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and Sudo_Id(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
function FunctionStatus(arg, result)
redis:srem('GLOBLA:'..bot_id.."Removal:User:Groups", result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:sadd('GLOBLA:'..bot_id.."Basic:User"..msg.chat_id_, result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:srem('GLOBLA:'..bot_id.."Basic:User"..msg.chat_id_, result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:sadd('GLOBLA:'..bot_id.."Constructor:Group"..msg.chat_id_, result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:srem('GLOBLA:'..bot_id.."Constructor:Group"..msg.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","⌔︙تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
function FunctionStatus(arg, result)
redis:sadd('GLOBLA:'..bot_id.."Manager:Group"..msg.chat_id_, result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:srem('GLOBLA:'..bot_id.."Manager:Group"..msg.chat_id_, result.sender_user_id_)
...
if not Constructor(msg) and redis:get('GLOBLA:'..bot_id.."Status:Cheking:Seted"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'⌔︙لا تستطيع رفع احد وذالك لان تم تعطيل الرفع من قبل المنشئين')
return false
end
function FunctionStatus(arg, result)
redis:sadd('GLOBLA:'..bot_id.."Admin:Group"..msg.chat_id_, result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:srem('GLOBLA:'..bot_id.."Admin:Group"..msg.chat_id_, result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:sadd('GLOBLA:'..bot_id.."Vip:Group"..msg.chat_id_, result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:srem('GLOBLA:'..bot_id.."Vip:Group"..msg.chat_id_, result.sender_user_id_)
...
if not Constructor(msg) and redis:get('GLOBLA:'..bot_id.."Status:Lock:Ban:Group"..msg.chat_id_) then 
...
redis:sadd('GLOBLA:'..bot_id.."Removal:User:Group"..msg.chat_id_, result.sender_user_id_)
KickGroup(result.chat_id_, result.sender_user_id_)
...
redis:srem('GLOBLA:'..bot_id.."Removal:User:Group"..msg.chat_id_, result.sender_user_id_)
...
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_, result.sender_user_id_)
...
function FunctionStatus(arg, result)
redis:srem('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_, result.sender_user_id_)
...
redis:srem('GLOBLA:'..bot_id.."Keed:User:Group"..msg.chat_id_, result.sender_user_id_)
...
redis:sadd('GLOBLA:'..bot_id.."Keed:User:Group"..msg.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","⌔︙تم تقييده")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text and text:match("^حظر عام @(.*)$") and Sudo_Id(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^حظر عام @(.*)$")}, FunctionStatus, nil)
elseif text and text:match("^الغاء العام @(.*)$") and Sudo_Id(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
...
redis:sadd('GLOBLA:'..bot_id.."Basic:User"..msg.chat_id_, result.id_)
...
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem('GLOBLA:'..bot_id.."Basic:User"..msg.chat_id_, result.id_)
...
redis:sadd('GLOBLA:'..bot_id.."Constructor:Group"..msg.chat_id_, result.id_)
...
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem('GLOBLA:'..bot_id.."Constructor:Group"..msg.chat_id_, result.id_)
Send_Options(msg,result.id_,"reply","⌔︙تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"⌔︙المعرف غلط ")
end
...
redis:sadd('GLOBLA:'..bot_id.."Manager:Group"..msg.chat_id_, result.id_)
...
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem('GLOBLA:'..bot_id.."Manager:Group"..msg.chat_id_, result.id_)
...
redis:sadd('GLOBLA:'..bot_id.."Admin:Group"..msg.chat_id_, result.id_)
...
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem('GLOBLA:'..bot_id.."Admin:Group"..msg.chat_id_, result.id_)
...
redis:sadd('GLOBLA:'..bot_id.."Vip:Group"..msg.chat_id_, result.id_)
...
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem('GLOBLA:'..bot_id.."Vip:Group"..msg.chat_id_, result.id_)
...
if redis:sismember('GLOBLA:'..bot_id.."Validitys:Group"..msg.chat_id_,text:match("رفع (.*)")) then
function Status_reply(extra, result, success)   
local statusrt = redis:get('GLOBLA:'..bot_id.."Add:Validity:Group:Rt"..text:match("رفع (.*)")..msg.chat_id_)
if statusrt == "مميز" and Admin(msg) then
redis:set('GLOBLA:'..bot_id.."Add:Validity:Users"..msg.chat_id_..result.sender_user_id_,text:match("رفع (.*)")) 
redis:sadd('GLOBLA:'..bot_id.."Vip:Group"..msg.chat_id_,result.sender_user_id_)  
...
if redis:sismember('GLOBLA:'..bot_id.."Validitys:Group"..msg.chat_id_,text:match("تنزيل (.*)")) then
function Status_reply(extra, result, success)   
local statusrt = redis:get('GLOBLA:'..bot_id.."Add:Validity:Group:Rt"..text:match("تنزيل (.*)")..msg.chat_id_)
if statusrt == "مميز" and Admin(msg) then 
redis:srem('GLOBLA:'..bot_id.."Vip:Group"..msg.chat_id_,result.sender_user_id_)  
redis:del('GLOBLA:'..bot_id.."Add:Validity:Users"..msg.chat_id_..result.sender_user_id_)
elseif statusrt == "ادمن" and Owner(msg) then 
redis:srem('GLOBLA:'..bot_id.."Admin:Group"..msg.chat_id_,result.sender_user_id_) 
redis:del('GLOBLA:'..bot_id.."Add:Validity:Users"..msg.chat_id_..result.sender_user_id_)
elseif statusrt == "مدير" and Constructor(msg) then
...
if redis:sismember('GLOBLA:'..bot_id.."Validitys:Group"..msg.chat_id_,text1[2]) then
function status_username(extra, result, success)   
if (result.id_) then
local statusrt = redis:get('GLOBLA:'..bot_id.."Add:Validity:Group:Rt"..text1[2]..msg.chat_id_)
if statusrt == "مميز" and Admin(msg) then
redis:sadd('GLOBLA:'..bot_id.."Vip:Group"..msg.chat_id_,result.id_)  
redis:set('GLOBLA:'..bot_id.."Add:Validity:Users"..msg.chat_id_..result.id_,text1[2])
elseif statusrt == "ادمن" and Owner(msg) then 
redis:sadd('GLOBLA:'..bot_id.."Admin:Group"..msg.chat_id_,result.id_)  
redis:set('GLOBLA:'..bot_id.."Add:Validity:Users"..msg.chat_id_..result.id_,text1[2])
elseif statusrt == "مدير" and Constructor(msg) then
...
if statusrt == "مميز" and Admin(msg) then
redis:srem('GLOBLA:'..bot_id.."Vip:Group"..msg.chat_id_,result.id_)  
redis:del('GLOBLA:'..bot_id.."Add:Validity:Users"..msg.chat_id_..result.id_)
elseif statusrt == "ادمن" and Owner(msg) then 
redis:srem('GLOBLA:'..bot_id.."Admin:Group"..msg.chat_id_,result.id_)  
redis:del('GLOBLA:'..bot_id.."Add:Validity:Users"..msg.chat_id_..result.id_)
elseif statusrt == "مدير" and Constructor(msg) then 
...
redis:sadd('GLOBLA:'..bot_id.."Removal:User:Group"..msg.chat_id_, result.id_)
...
redis:srem('GLOBLA:'..bot_id.."Removal:User:Group"..msg.chat_id_, result.id_)
...
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_, result.id_)
...
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_, result.id_)
...
elseif text and text:match("^حظر عام (%d+)$") and Sudo_Id(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
if Sudo_Id_User(text:match("^حظر عام (%d+)$")) == true then
send(msg.chat_id_, msg.id_, "⌔︙لا تستطيع حظر المطور الاساسي عام")
return false 
end
...
redis:sadd('GLOBLA:'..bot_id.."Removal:User:Groups", text:match("^حظر عام (%d+)$"))
Send_Options(msg,text:match("^حظر عام (%d+)$"),"reply","⌔︙تم حظره عام من المجموعات")  
elseif text and text:match("^الغاء العام (%d+)$") and Sudo_Id(msg) then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
redis:srem('GLOBLA:'..bot_id.."Removal:User:Groups", text:match("^الغاء العام (%d+)$"))
...
redis:sadd('GLOBLA:'..bot_id.."Basic:User"..msg.chat_id_, text:match("^رفع منشئ اساسي (%d+)$") )
...
redis:srem('GLOBLA:'..bot_id.."Basic:User"..msg.chat_id_, text:match("^تنزيل منشئ اساسي (%d+)$") )
...
redis:sadd('GLOBLA:'..bot_id.."Constructor:Group"..msg.chat_id_, text:match("^رفع منشئ (%d+)$"))
...
redis:srem('GLOBLA:'..bot_id.."Constructor:Group"..msg.chat_id_, text:match("^تنزيل منشئ (%d+)$"))
...
redis:sadd('GLOBLA:'..bot_id.."Manager:Group"..msg.chat_id_, text:match("^رفع مدير (%d+)$") )
...
redis:srem('GLOBLA:'..bot_id.."Manager:Group"..msg.chat_id_, text:match("^تنزيل مدير (%d+)$") )
...
redis:sadd('GLOBLA:'..bot_id.."Admin:Group"..msg.chat_id_, text:match("^رفع ادمن (%d+)$"))
...
redis:srem('GLOBLA:'..bot_id.."Admin:Group"..msg.chat_id_, text:match("^تنزيل ادمن (%d+)$"))
...
redis:sadd('GLOBLA:'..bot_id.."Vip:Group"..msg.chat_id_, text:match("^رفع مميز (%d+)$"))
...
redis:srem('GLOBLA:'..bot_id.."Vip:Group"..msg.chat_id_, text:match("^تنزيل مميز (%d+)$") )
...
redis:sadd('GLOBLA:'..bot_id.."Removal:User:Group"..msg.chat_id_, text:match("^حظر (%d+)$") )
...
redis:srem('GLOBLA:'..bot_id.."Removal:User:Group"..msg.chat_id_, text:match("^الغاء حظر (%d+)$") )
...
redis:sadd('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_, text:match("^كتم (%d+)$"))
...
redis:srem('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,text:match("^الغاء كتم (%d+)$") )
...
redis:set('GLOBLA:'..bot_id.."Status:lock:Far"..msg.chat_id_,true) 
...
redis:set('GLOBLA:'..bot_id.."Status:lock:Fsh"..msg.chat_id_,true) 
...
redis:set('GLOBLA:'..bot_id.."Status:Lock:text"..msg.chat_id_,true) 
...
redis:set('GLOBLA:'..bot_id.."Status:Lock:AddMempar"..msg.chat_id_,"kick")  
...
redis:set('GLOBLA:'..bot_id.."Status:Lock:Join"..msg.chat_id_,"kick")  
...
redis:set('GLOBLA:'..bot_id.."Status:Lock:Bot:kick"..msg.chat_id_,"del")  
...
redis:set('GLOBLA:'..bot_id.."Status:Lock:Bot:kick"..msg.chat_id_,"kick")  
...
redis:set('GLOBLA:'..bot_id.."Status:Lock:tagservr"..msg.chat_id_,true)  
...
redis:set('GLOBLA:'..bot_id.."Status:lockpin"..msg.chat_id_, true) 
redis:sadd('GLOBLA:'..bot_id.."Status:Lock:pin",msg.chat_id_) 
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  redis:set('GLOBLA:'..bot_id.."Get:Id:Msg:Pin"..msg.chat_id_,data.pinned_message_id_)  end,nil)
...
redis:set('GLOBLA:'..bot_id.."Status:Lock:edit"..msg.chat_id_,true) 
...
redis:set('GLOBLA:'..bot_id.."Status:Lock:tagservrbot"..msg.chat_id_,true)   
list ={"Status:Lock:Bot:kick","Status:Lock:User:Name","Status:Lock:hashtak","Status:Lock:Cmd","Status:Lock:Link","Status:Lock:forward","Status:Lock:Keyboard","Status:Lock:geam","Status:Lock:Photo","Status:Lock:Animation","Status:Lock:Video","Status:Lock:Audio","Status:Lock:vico","Status:Lock:Sticker","Status:Lock:Document","Status:Lock:Unsupported","Status:Lock:Markdaun","Status:Lock:Contact","Status:Status:Lock:Spam"}
for i,lock in pairs(list) do;redis:set('GLOBLA:'..bot_id..lock..msg.chat_id_,"del");end
...
redis:del('GLOBLA:'..bot_id.."Status:Lock:AddMempar"..msg.chat_id_)  
...
redis:del('GLOBLA:'..bot_id.."Status:lock:Far"..msg.chat_id_) 
...
redis:del('GLOBLA:'..bot_id.."Status:lock:Fsh"..msg.chat_id_) 
...
redis:del('GLOBLA:'..bot_id.."Status:Lock:text"..msg.chat_id_)  
...
redis:del('GLOBLA:'..bot_id.."Status:Lock:Join"..msg.chat_id_)  
...
redis:del('GLOBLA:'..bot_id.."Status:Lock:Bot:kick"..msg.chat_id_)  
...
redis:del('GLOBLA:'..bot_id.."Status:Lock:tagservr"..msg.chat_id_)  
...
redis:del('GLOBLA:'..bot_id.."Status:lockpin"..msg.chat_id_)  
redis:srem('GLOBLA:'..bot_id.."Status:Lock:pin",msg.chat_id_)
...
redis:del('GLOBLA:'..bot_id.."Status:Lock:edit"..msg.chat_id_) 
...
redis:set('GLOBLA:'..bot_id.."Status:Lock:Markdaun"..msg.chat_id_,"ked")  
...
redis:set('GLOBLA:'..bot_id.."Status:Lock:Markdaun"..msg.chat_id_,"ktm")  
...
redis:hset('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
Send_Options(msg,msg.sender_user_id_,"Close_Status_Kid","⌔︙تم قفـل التكرار")
elseif text == "قفل التكرار بالكتم" and Admin(msg) then 
redis:hset('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
Send_Options(msg,msg.sender_user_id_,"Close_Status_Ktm","⌔︙تم قفـل التكرار")
elseif text == "فتح التكرار" and Admin(msg) then 
redis:hdel('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
Send_Options(msg,msg.sender_user_id_,"Open_Status","⌔︙تم فتح التكرار")
elseif text == "تفعيل الحمايه القصوى" and Owner(msg) then  
redis:set('GLOBLA:'..bot_id.."Link_Group"..msg.chat_id_,true) 
redis:set('GLOBLA:'..bot_id.."Status:Status:Lock:Spam"..msg.chat_id_,"del")  
redis:hset('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
redis:set('GLOBLA:'..bot_id..'Status:Lock:Id:Py:Photo'..msg.chat_id_,true) 
redis:set('GLOBLA:'..bot_id.."Chek:Welcome"..msg.chat_id_,true) 
redis:set('GLOBLA:'..bot_id.."Status:Lock:Ban:Group"..msg.chat_id_,"true")
redis:set('GLOBLA:'..bot_id.."Status:Cheking:Seted"..msg.chat_id_,"true")
redis:set('GLOBLA:'..bot_id.."Status:Lock:tagservrbot"..msg.chat_id_,true)   
...
redis:del('GLOBLA:'..bot_id.."Link_Group"..msg.chat_id_) 
...
redis:del('GLOBLA:'..bot_id.."Status:Reply:Manager"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"⌔︙تم تفعيل ردود المدير") 
elseif text == "تعطيل ردود المدير" and Owner(msg) then  
redis:set('GLOBLA:'..bot_id.."Status:Reply:Manager"..msg.chat_id_,true)  
send(msg.chat_id_, msg.id_,"⌔︙تم تعطيل ردود المدير" ) 
elseif text == "تفعيل ردود المطور" and Owner(msg) then   
redis:del('GLOBLA:'..bot_id.."Status:Reply:Sudo"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"⌔︙تم تفعيل ردود المطور" ) 
elseif text == "تعطيل ردود المطور" and Owner(msg) then  
redis:set('GLOBLA:'..bot_id.."Status:Reply:Sudo"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_,"⌔︙تم تعطيل ردود المطور" ) 
elseif text == "تفعيل اطردني" and Owner(msg) then   
redis:del('GLOBLA:'..bot_id.."Status:Cheking:Kick:Me:Group"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,Text) 
elseif text == "تعطيل اطردني" and Owner(msg) then  
redis:set('GLOBLA:'..bot_id.."Status:Cheking:Kick:Me:Group"..msg.chat_id_,true)  
send(msg.chat_id_, msg.id_,"⌔︙تم تعطيل امر اطردني") 
elseif text == "تفعيل المغادره" and Sudo_Id(msg) then   
redis:del('GLOBLA:'..bot_id.."Status:Lock:Left"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"⌔︙تم تفعيل مغادرة البوت") 
elseif text == "تعطيل المغادره" and Sudo_Id(msg) then  
redis:set('GLOBLA:'..bot_id.."Status:Lock:Left"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "⌔︙تم تعطيل مغادرة البوت") 
elseif text == "تفعيل الاذاعه" and Sudo_Id(msg) then  
redis:del('GLOBLA:'..bot_id.."Status:Broadcasting:Bot") 
send(msg.chat_id_, msg.id_,"⌔︙تم تفعيل الاذاعه \n⌔︙الان يمكن للمطورين الاذاعه" ) 
elseif text == "تعطيل الاذاعه" and Sudo_Id(msg) then  
redis:set('GLOBLA:'..bot_id.."Status:Broadcasting:Bot",true) 
send(msg.chat_id_, msg.id_,"⌔︙تم تعطيل الاذاعه") 
elseif text == "تعطيل اوامر التحشيش" and Owner(msg) then    
send(msg.chat_id_, msg.id_, '⌔︙تم تعطيل اوامر التحشيش')
redis:set('GLOBLA:'..bot_id.."Status:Fun:Group"..msg.chat_id_,"true")
elseif text == "تفعيل اوامر التحشيش" and Owner(msg) then    
send(msg.chat_id_, msg.id_,'⌔︙تم تفعيل اوامر التحشيش')
redis:del('GLOBLA:'..bot_id.."Status:Fun:Group"..msg.chat_id_)
elseif text == 'تفعيل الايدي' and Owner(msg) then   
redis:del('GLOBLA:'..bot_id..'Status:Lock:Id:Photo'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'⌔︙تم تفعيل الايدي') 
elseif text == 'تعطيل الايدي' and Owner(msg) then  
redis:set('GLOBLA:'..bot_id..'Status:Lock:Id:Photo'..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,'⌔︙تم تعطيل الايدي') 
elseif text == 'تفعيل الايدي بالصوره' and Owner(msg) then   
redis:del('GLOBLA:'..bot_id..'Status:Lock:Id:Py:Photo'..msg.chat_id_) 
...
redis:del('GLOBLA:'..bot_id.."Status:Lock:Game:Group"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"⌔︙تم تعطيل الالعاب") 
elseif text == "تفعيل الالعاب" and Owner(msg) then  
redis:set('GLOBLA:'..bot_id.."Status:Lock:Game:Group"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_,"⌔︙تم تفعيل الالعاب") 
elseif text == 'تفعيل البوت الخدمي' and Sudo_Id(msg) then  
redis:del('GLOBLA:'..bot_id..'Free:Bot') 
send(msg.chat_id_, msg.id_,'⌔︙تم تفعيل البوت الخدمي \n⌔︙الان يمكن الجميع تفعيله') 
elseif text == 'تعطيل البوت الخدمي' and Sudo_Id(msg) then  
redis:set('GLOBLA:'..bot_id..'Free:Bot',true) 
send(msg.chat_id_, msg.id_,'⌔︙تم تعطيل البوت الخدمي') 
...
redis:del('GLOBLA:'..bot_id.."Status:Lock:Ban:Group"..msg.chat_id_)
...
redis:del('GLOBLA:'..bot_id.."Status:Cheking:Seted"..msg.chat_id_)
...
if redis:sismember('GLOBLA:'..bot_id.."Status:Lock:pin",msg.chat_id_) and not Constructor(msg) then
...
redis:set('GLOBLA:'..bot_id.."Get:Id:Msg:Pin"..msg.chat_id_,msg.reply_to_message_id_)
...
redis:del('GLOBLA:'..bot_id.."Get:Id:Msg:Pin"..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"⌔︙البوت ليس ادمن هنا")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"⌔︙ليست لدي صلاحية التثبيت .")
...
redis:del('GLOBLA:'..bot_id..":Rules:Group"..msg.chat_id_) 
elseif text == 'حذف الايدي' and Owner(msg) or text == 'مسح الايدي' and Owner(msg) then
redis:del('GLOBLA:'..bot_id.."Set:Id:Group"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '⌔︙تم ازالة كليشة الايدي ')
elseif text == 'مسح رسائلي' then
redis:del('GLOBLA:'..bot_id..'Num:Message:User'..msg.chat_id_..':'..msg.sender_user_id_)
redis:del('GLOBLA:'..bot_id..'Num:Message:Userr'..msg.chat_id_..':'..msg.sender_user_id_)
...
redis:del('GLOBLA:'..bot_id..'Num:Message:Edit'..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_, msg.id_,'⌔︙تم مسح جميع تعديلاتك ') 
elseif text == 'مسح جهاتي' then
redis:del('GLOBLA:'..bot_id..'Num:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
...
redis:hset('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,text:match("^وضع تكرار (%d+)$")) 
...
redis:hset('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,text:match("^وضع زمن التكرار (%d+)$")) 
...
redis:setex('GLOBLA:'..bot_id.."Status:link:set"..msg.chat_id_..""..msg.sender_user_id_,120,true) 
...
redis:set('GLOBLA:'..bot_id.."Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_,true) 
send(msg.chat_id_,msg.id_,"⌔︙ارسل الصوره لوضعها") 
elseif text == "ضع وصف" and Admin(msg) or text == "وضع وصف" and Admin(msg) then  
redis:setex('GLOBLA:'..bot_id.."Change:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
redis:setex('GLOBLA:'..bot_id.."Redis:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_,msg.id_,"⌔︙ارسل لي القوانين الان")  
elseif text == 'وضع كليشه المطور' and Sudo_Id(msg) then
redis:set('GLOBLA:'..bot_id..'GetTexting:DevGLOBLA'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'⌔︙ ارسل لي الكليشه الان')
...
elseif text == 'روابط الكروبات' and Sudo_Id(msg) then
local list = redis:smembers('GLOBLA:'..bot_id..'Groups_Users') 
test = '⌔︙روابط الكروبات \n\n'
for k,v in pairs(list) do 
local link = redis:get('GLOBLA:'..bot_id.."Private:Group:Link"..v)   
...
local status_Link = redis:get('GLOBLA:'..bot_id.."Link_Group"..msg.chat_id_)
if status_Link then
...
send(msg.chat_id_,msg.id_,"- Link group :\n••━━━━━━━━━━••\n ["..linkgpp.result.."]")
redis:set('GLOBLA:'..bot_id.."Private:Group:Link"..msg.chat_id_,linkgpp.result)
else
...
Welcome = redis:get('GLOBLA:'..bot_id.."Get:Welcome:Group"..msg.chat_id_)  
else 
...
for k,v in pairs(list) do  
redis:del('GLOBLA:'..bot_id.."Filter:Reply1"..msg.sender_user_id_..msg.chat_id_)  
redis:del('GLOBLA:'..bot_id.."Filter:Reply2"..v..msg.chat_id_)  
...
t = "\n⌔︙قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do  
local FilterMsg = redis:get('GLOBLA:'..bot_id.."Filter:Reply2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..FilterMsg.."}\n"    
end  
if #list == 0 then  
...
redis:set('GLOBLA:'..bot_id.."Filter:Reply1"..msg.sender_user_id_..msg.chat_id_,"SetFilter")  
return false  
elseif text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Admin(msg) then    
send(msg.chat_id_, msg.id_,"⌔︙ارسل الكلمه الان")  
redis:set('GLOBLA:'..bot_id.."Filter:Reply1"..msg.sender_user_id_..msg.chat_id_,"DelFilter")  
return false  
...
local Set_Rules = redis:get('GLOBLA:'..bot_id..":Rules:Group" .. msg.chat_id_)   
if Set_Rules then     
...
redis:del('GLOBLA:'..bot_id.."Add:Validity:Group:Rt"..ComdNew..msg.chat_id_)
redis:srem('GLOBLA:'..bot_id.."Validitys:Group"..msg.chat_id_,ComdNew)  
send(msg.chat_id_, msg.id_, "\n⌔︙تم مسح ← { "..ComdNew..' } من الصلاحيات') 
elseif text and text:match("^اضف صلاحيه (.*)$") and Admin(msg) then 
local ComdNew = text:match("^اضف صلاحيه (.*)$")
redis:set('GLOBLA:'..bot_id.."Add:Validity:Group:Rt:New"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
redis:sadd('GLOBLA:'..bot_id.."Validitys:Group"..msg.chat_id_,ComdNew)  
redis:setex('GLOBLA:'..bot_id.."Redis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
elseif text == ("مسح ردود المطور") and Sudo_Id(msg) then 
...
elseif text == ("ردود المطور") and Sudo_Id(msg) then 
local list = redis:smembers('GLOBLA:'..bot_id.."List:Rd:Sudo")
text = "\n⌔︙قائمة ردود المطور \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,"["..text.."]")
elseif text == "اضف رد للكل" and Sudo_Id(msg) then 
...
elseif text == "حذف رد للكل" and Sudo_Id(msg) then 
...
if redis:sismember('GLOBLA:'..bot_id.."Developer:Bot",result.id_) then
dev = "⌔︙( المطور ... ✓️) \n" else dev = "" end
if redis:sismember('GLOBLA:'..bot_id.."President:User"..msg.chat_id_, result.id_) then
mal = "⌔︙( المالك ... ✓️) \n" else mal = "" end
if redis:sismember('GLOBLA:'..bot_id.."Basic:User"..msg.chat_id_, result.id_) then
crr = "⌔︙( المنشئ الاساسي ... ✓️) \n" else crr = "" end
if redis:sismember('GLOBLA:'..bot_id..'Constructor:Group'..msg.chat_id_, result.id_) then
cr = "⌔︙( المنشئ ... ✓️) \n" else cr = "" end
if redis:sismember('GLOBLA:'..bot_id..'Manager:Group'..msg.chat_id_, result.id_) then
own = "⌔︙( المدير ... ✓️) \n" else own = "" end
if redis:sismember('GLOBLA:'..bot_id..'Admin:Group'..msg.chat_id_, result.id_) then
mod = "⌔︙( الادمن ... ✓️) \n" else mod = "" end
if redis:sismember('GLOBLA:'..bot_id..'Vip:Group'..msg.chat_id_, result.id_) then
vip = "⌔︙( عضو مميز ... ✓️) \n" else vip = ""
end
...
if Sudo_Id_User(msg.sender_user_id_) == true then
redis:srem('GLOBLA:'..bot_id.."Developer:Bot", result.id_)
redis:srem('GLOBLA:'..bot_id.."President:User"..msg.chat_id_,result.id_)
redis:srem('GLOBLA:'..bot_id.."Basic:User"..msg.chat_id_,result.id_)
redis:srem('GLOBLA:'..bot_id..'Constructor:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id..'Manager:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id..'Admin:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id..'Vip:Group'..msg.chat_id_, result.id_)
elseif redis:sismember('GLOBLA:'..bot_id.."Developer:Bot",msg.sender_user_id_) then
redis:srem('GLOBLA:'..bot_id..'Vip:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id..'Admin:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id..'Manager:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id..'Constructor:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id.."Basic:User"..msg.chat_id_,result.id_)
redis:srem('GLOBLA:'..bot_id.."President:User"..msg.chat_id_,result.id_)
elseif redis:sismember('GLOBLA:'..bot_id.."President:User"..msg.chat_id_, msg.sender_user_id_) then
redis:srem('GLOBLA:'..bot_id..'Admin:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id..'Vip:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id..'Manager:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id..'Constructor:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id.."Basic:User"..msg.chat_id_,result.id_)
elseif redis:sismember('GLOBLA:'..bot_id.."Basic:User"..msg.chat_id_, msg.sender_user_id_) then
redis:srem('GLOBLA:'..bot_id..'Admin:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id..'Vip:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id..'Manager:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id..'Constructor:Group'..msg.chat_id_, result.id_)
elseif redis:sismember('GLOBLA:'..bot_id..'Constructor:Group'..msg.chat_id_, msg.sender_user_id_) then
redis:srem('GLOBLA:'..bot_id..'Admin:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id..'Vip:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id..'Manager:Group'..msg.chat_id_, result.id_)
elseif redis:sismember('GLOBLA:'..bot_id..'Manager:Group'..msg.chat_id_, msg.sender_user_id_) then
redis:srem('GLOBLA:'..bot_id..'Admin:Group'..msg.chat_id_, result.id_)
redis:srem('GLOBLA:'..bot_id..'Vip:Group'..msg.chat_id_, result.id_)
end
end
...
if redis:sismember('GLOBLA:'..bot_id.."Developer:Bot",result.sender_user_id_) then
dev = "⌔︙( المطور ... ✓️) \n" else dev = "" end
if redis:sismember('GLOBLA:'..bot_id.."President:User"..msg.chat_id_, result.id_) then
mal = "⌔︙( المالك ... ✓️) \n" else mal = "" end
if redis:sismember('GLOBLA:'..bot_id.."Basic:User"..msg.chat_id_, result.sender_user_id_) then
crr = "⌔︙( المنشئ الاساسي ... ✓️) \n" else crr = "" end
if redis:sismember('GLOBLA:'..bot_id..'Constructor:Group'..msg.chat_id_, result.sender_user_id_) then
cr = "⌔︙( المنشئ ... ✓️) \n" else cr = "" end
if redis:sismember('GLOBLA:'..bot_id..'Manager:Group'..msg.chat_id_, result.sender_user_id_) then
own = "⌔︙( المدير ... ✓️) \n" else own = "" end
if redis:sismember('GLOBLA:'..bot_id..'Admin:Group'..msg.chat_id_, result.sender_user_id_) then
mod = "⌔︙( الادمن ... ✓️) \n" else mod = "" end
if redis:sismember('GLOBLA:'..bot_id..'Vip:Group'..msg.chat_id_, result.sender_user_id_) then
vip = "⌔︙( عضو مميز ... ✓️) \n" else vip = ""
end
...
if Sudo_Id_User(msg.sender_user_id_) == true then
redis:srem('GLOBLA:'..bot_id.."Developer:Bot", result.sender_user_id_)
redis:srem('GLOBLA:'..bot_id.."President:User"..msg.chat_id_,result.sender_user_id_)
redis:srem('GLOBLA:'..bot_id.."Basic:User"..msg.chat_id_,result.sender_user_id_)
redis:srem('GLOBLA:'..bot_id..'Constructor:Group'..msg.chat_id_, result.sender_user_id_)
redis:srem('GLOBLA:'..bot_id..'Manager:Group'..msg.chat_id_, result.sender_user_id_)
redis:srem('GLOBLA:'..bot_id..'Admin:Group'..msg.chat_id_, result.sender_user_id_)
...
if DeveloperBot(msg) and not redis:get('GLOBLA:'..bot_id.."Status:Lock:Left"..msg.chat_id_) then 
...
redis:srem('GLOBLA:'..bot_id.."Groups_Users",GP_ID[2])  
end
...
elseif text == "تغير اسم البوت" and Sudo_Id(msg) or text == "تغيير اسم البوت" and Sudo_Id(msg) then 
redis:setex('GLOBLA:'..bot_id.."Change:Name:Bot"..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"⌔︙ ارسل لي الاسم الان ")  
elseif text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and DeveloperBot(msg) then 
if redis:get('GLOBLA:'..bot_id.."Status:Broadcasting:Bot") and not Sudo_Id(msg) then 
...
if redis:get('GLOBLA:'..bot_id.."Status:lockpin"..msg.chat_id_) then    
lock_pin = "{✔️}"
else 
lock_pin = "{✖}"    
end
if redis:get('GLOBLA:'..bot_id.."Status:Lock:tagservr"..msg.chat_id_) then    
lock_tagservr = "{✔️}"
else 
lock_tagservr = "{✖}"
end
if redis:get('GLOBLA:'..bot_id.."Status:Lock:text"..msg.chat_id_) then    
lock_text = "← {✔️}"
else 
lock_text = "← {✖}"    
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:edit"..msg.chat_id_) then    
lock_edit = "← {✔️}"
else 
lock_edit = "← {✖}"    
end
if redis:get('GLOBLA:'..bot_id.."Chek:Welcome"..msg.chat_id_) then
welcome = "← {✔️}"
else 
welcome = "← {✖}"    
end
if redis:hget('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "← { بالطرد }"     
elseif redis:hget('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "← { بالتقيد }"     
elseif redis:hget('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "← { بالكتم }"           
elseif redis:hget('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "← {✔️}"
else     
flood = "← {✖}"     
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Link"..msg.chat_id_) == "del" then
lock_links = "← {✔️}"
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Link"..msg.chat_id_) == "ked" then
lock_links = "← { بالتقيد }"    
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Link"..msg.chat_id_) == "ktm" then
lock_links = "← { بالكتم }"    
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Link"..msg.chat_id_) == "kick" then
lock_links = "← { بالطرد }"    
else
lock_links = "← {✖}"    
end
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Cmd"..msg.chat_id_) == "del" then
lock_cmds = "← {✔️}"
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Cmd"..msg.chat_id_) == "ked" then
lock_cmds = "← { بالتقيد }"    
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Cmd"..msg.chat_id_) == "ktm" then
lock_cmds = "← { بالكتم }"   
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Cmd"..msg.chat_id_) == "kick" then
lock_cmds = "← { بالطرد }"    
else
lock_cmds = "← {✖}"    
end
if redis:get('GLOBLA:'..bot_id.."Status:Lock:User:Name"..msg.chat_id_) == "del" then
lock_user = "← {✔️}"
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:User:Name"..msg.chat_id_) == "ked" then
lock_user = "← { بالتقيد }"    
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:User:Name"..msg.chat_id_) == "ktm" then
lock_user = "← { بالكتم }"    
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:User:Name"..msg.chat_id_) == "kick" then
lock_user = "← { بالطرد }"    
else
lock_user = "← {✖}"    
end
if redis:get('GLOBLA:'..bot_id.."Status:Lock:hashtak"..msg.chat_id_) == "del" then
lock_hash = "← {✔️}"
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:hashtak"..msg.chat_id_) == "ked" then 
lock_hash = "← { بالتقيد }"    
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:hashtak"..msg.chat_id_) == "ktm" then 
lock_hash = "← { بالكتم }"    
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:hashtak"..msg.chat_id_) == "kick" then 
lock_hash = "← { بالطرد }"    
else
lock_hash = "← {✖}"    
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Bot:kick"..msg.chat_id_) == "del" then
lock_bots = "← {✔️}"
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Bot:kick"..msg.chat_id_) == "ked" then
lock_bots = "← { بالتقيد }"   
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Bot:kick"..msg.chat_id_) == "kick" then
lock_bots = "← { بالطرد }"    
else
lock_bots = "← {✖}"    
end
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Spam"..msg.chat_id_) == "del" then    
lock_spam = "← {✔️}"
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Spam"..msg.chat_id_) == "ked" then 
lock_spam = "← { بالتقيد }"    
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Spam"..msg.chat_id_) == "ktm" then 
lock_spam = "← { بالكتم }"    
elseif redis:get('GLOBLA:'..bot_id.."Status:Lock:Spam"..msg.chat_id_) == "kick" then 
lock_spam = "← { بالطرد }"    
else
lock_spam = "← {✖}"    
end        
if not redis:get('GLOBLA:'..bot_id.."Status:Reply:Manager"..msg.chat_id_) then
ReplyManager = "← {✔️}"
else
ReplyManager = "← {✖}"
end
if not redis:get('GLOBLA:'..bot_id.."Status:Reply:Sudo"..msg.chat_id_) then
ReplySudo = "← {✔️}"
else
ReplySudo = "← {✖}"
end
if not redis:get('GLOBLA:'..bot_id.."Status:Lock:Id:Photo"..msg.chat_id_)  then
IdPhoto = "← {✔️}"
else
IdPhoto = "← {✖}"
end
if not redis:get('GLOBLA:'..bot_id.."Status:Lock:Id:Py:Photo"..msg.chat_id_) then
IdPyPhoto = "← {✔️}"
else
IdPyPhoto = "← {✖}"
end
if not redis:get('GLOBLA:'..bot_id.."Status:Cheking:Kick:Me:Group"..msg.chat_id_)  then
KickMe = "← {✔️}"
else
KickMe = "← {✖}"
end
if not redis:get('GLOBLA:'..bot_id.."Status:Lock:Ban:Group"..msg.chat_id_)  then
Banusers = "← {✔️}"
else
Banusers = "← {✖}"
end
if not redis:get('GLOBLA:'..bot_id.."Status:Cheking:Seted"..msg.chat_id_) then
Setusers = "← {✔️}"
else
Setusers = "← {✖}"
end
if redis:get('GLOBLA:'..bot_id.."Link_Group"..msg.chat_id_) then
Link_Group = "← {✔️}"
else
Link_Group = "← {✖}"
end
if not redis:get('GLOBLA:'..bot_id.."Status:Fun:Group"..msg.chat_id_) then
FunGroup = "← {✔️}"
else
FunGroup = "← {✖}"
end
local Num_Flood = redis:hget('GLOBLA:'..bot_id.."Spam:Group:User"..msg.chat_id_,"Num:Spam") or 0
send(msg.chat_id_, msg.id_,"*\n⌔︙اعدادات المجموعه "..
"\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"..
...
redis:setex('GLOBLA:'..bot_id.."Redis:Id:Group"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
send(msg.chat_id_, msg.id_,[[
⌔︙ارسل الان النص
⌔︙يمكنك اضافه :
...
redis:set('GLOBLA:'..bot_id.."Set:Id:Group"..msg.chat_id_,Text_Rand)
send(msg.chat_id_, msg.id_,'⌔︙ تم تغير الايدي ارسل ايدي لرؤيته')
end
if text == 'كشف' and tonumber(msg.reply_to_message_id_) > 0 and not redis:get('GLOBLA:'..bot_id..'Status:Lock:Id:Photo'..msg.chat_id_) then
function Function_Status(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Status, nil)
return false
elseif text and text:match("^كشف @(.*)$") and not redis:get('GLOBLA:'..bot_id..'Status:Lock:Id:Photo'..msg.chat_id_) then
...
if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not redis:get('GLOBLA:'..bot_id..'Status:Lock:Id:Photo'..msg.chat_id_) then
...
local NumMsgg1 = redis:get('GLOBLA:'..bot_id..'Num:Message:Userr'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local nummsg = redis:get('GLOBLA:'..bot_id..'Num:Message:User'..msg.chat_id_..':'..msg.sender_user_id_) or 1 
local NumMsg = (NumMsgg1 + nummsg)
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
local NumMessageEdit = redis:get('GLOBLA:'..bot_id..'Num:Message:Edit'..msg.chat_id_..msg.sender_user_id_) or 0
local Num_Games = redis:get('GLOBLA:'..bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_) or 0
local Add_Mem = redis:get('GLOBLA:'..bot_id.."Num:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
...
local Get_Is_Id = redis:get('GLOBLA:'..bot_id.."Set:Id:Group"..msg.chat_id_)
if not redis:get('GLOBLA:'..bot_id..'Status:Lock:Id:Py:Photo'..msg.chat_id_) then
...
elseif text == 'ايدي' and tonumber(msg.reply_to_message_id_) > 0 and not redis:get('GLOBLA:'..bot_id..'Status:Lock:Id:Photo'..msg.chat_id_) then
function Function_Status(extra, result, success)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.first_name_ == false then
send(msg.chat_id_, msg.id_,'⌔︙ الحساب محذوف لا توجد معلوماته ')
...
local Id = data.id_
local NumMsgg1 = redis:get('GLOBLA:'..bot_id..'Num:Message:Userr'..msg.chat_id_..':'..data.id_) or 0
local nummsg = redis:get('GLOBLA:'..bot_id..'Num:Message:User'..msg.chat_id_..':'..data.id_) or 1 
local NumMsg = (NumMsgg1 + nummsg)
local TotalMsg = Total_message(NumMsg)
local Status_Gps = Get_Rank(Id,msg.chat_id_)
local NumMessageEdit = redis:get('GLOBLA:'..bot_id..'Num:Message:Edit'..msg.chat_id_..data.id_) or 0
local Num_Games = redis:get('GLOBLA:'..bot_id.."Status:Msg_User"..msg.chat_id_..":"..data.id_) or 0
local Add_Mem = redis:get('GLOBLA:'..bot_id.."Num:Add:Memp"..msg.chat_id_..":"..data.id_) or 0
send(msg.chat_id_, msg.id_,'\n*⌔︙ايديه ← '..Id..'\n⌔︙رسائله ← '..NumMsg..'\n⌔︙معرفه ← *['..UserName_User..']*\n⌔︙تفاعله ← '..TotalMsg..'\n⌔︙رتبته ← '..Status_Gps..'\n⌔︙تعديلاته ← '..NumMessageEdit..'\n⌔︙جهاته ← '..Add_Mem..'*') 
end,nil)   
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Status, nil)
return false
elseif text and text:match("^ايدي @(.*)$") and not redis:get('GLOBLA:'..bot_id..'Status:Lock:Id:Photo'..msg.chat_id_) then
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Game:Group"..msg.chat_id_) then
redis:del('GLOBLA:'..bot_id.."Status:Set:Sma"..msg.chat_id_)
Random = {"🍏","🍎","🍐","🍊","🍋","🍉","🍇","🍓","🍈","🍒","🍑","🍍","🥥","🥝","🍅","🍆","🥑","🥦","🥒","🌶","🌽","🥕","🥔","🥖","🥐","🍞","🥨","🍟","🧀","🥚","🍳","🥓","🥩","🍗","🍖","🌭","🍔","🍠","🍕","🥪","🥙","☕️","??","🥤","🍶","🍺","🍻","🏀","⚽️","🏈","⚾️","🎾","🏐","🏉","🎱","🏓","🏸","🥅","🎰","🎮","🎳","🎯","🎲","🎻","🎸","🎺","🥁","🎹","🎼","🎧","🎤","🎬","🎨","🎭","🎪","🎟","🎫","🎗","🏵","🎖","🏆","🥌","🛷","🚗","🚌","🏎","🚓","🚑","🚚","🚛","🚜","🇮🇶","⚔","🛡","🔮","🌡","💣","📌","📍","📓","📗","📂","📅","📪","📫","📬","📭","⏰","📺","🎚","☎️","📡"}
SM = Random[math.random(#Random)]
redis:set('GLOBLA:'..bot_id.."Status:Random:Sm"..msg.chat_id_,SM)
send(msg.chat_id_, msg.id_,"⌔︙اسرع واحد يدز هاذا السمايل ? ~ {`"..SM.."`}")
return false
end
elseif text == "الاسرع" or tect == "ترتيب" then
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Game:Group"..msg.chat_id_) then
redis:del('GLOBLA:'..bot_id.."Status:Speed:Tr"..msg.chat_id_)
KlamSpeed = {"سحور","سياره","استقبال","قنفه","ايفون","بزونه","مطبخ","كرستيانو","دجاجه","مدرسه","الوان","غرفه","ثلاجه","كهوه","سفينه","العراق","محطه","طياره","رادار","منزل","مستشفى","كهرباء","تفاحه","اخطبوط","سلمون","فرنسا","برتقاله","تفاح","مطرقه","بتيته","لهانه","شباك","باص","سمكه","ذباب","تلفاز","حاسوب","انترنيت","ساحه","جسر"};
name = KlamSpeed[math.random(#KlamSpeed)]
redis:set('GLOBLA:'..bot_id.."Status:Klam:Speed"..msg.chat_id_,name)
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Game:Group"..msg.chat_id_) then
redis:del('GLOBLA:'..bot_id.."Status:Set:Hzora"..msg.chat_id_)
Hzora = {"الجرس","عقرب الساعه","السمك","المطر","5","الكتاب","البسمار","7","الكعبه","بيت الشعر","لهانه","انا","امي","الابره","الساعه","22","غلط","كم الساعه","البيتنجان","البيض","المرايه","الضوء","الهواء","الضل","العمر","القلم","المشط","الحفره","البحر","الثلج","الاسفنج","الصوت","بلم"};
name = Hzora[math.random(#Hzora)]
redis:set('GLOBLA:'..bot_id.."Status:Klam:Hzor"..msg.chat_id_,name)
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Game:Group"..msg.chat_id_) then
redis:del('GLOBLA:'..bot_id.."Status:Set:Maany"..msg.chat_id_)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
redis:set('GLOBLA:'..bot_id.."Status:Maany"..msg.chat_id_,name)
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Game:Group"..msg.chat_id_) then
redis:del('GLOBLA:'..bot_id.."Status:Set:Aks"..msg.chat_id_)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
redis:set('GLOBLA:'..bot_id.."Status:Set:Aks:Game"..msg.chat_id_,name)
...
redis:set('GLOBLA:'..bot_id.."Status:GAMES:NUM"..msg.chat_id_,Num) 
send(msg.chat_id_, msg.id_,"\n⌔︙اهلا بك عزيزي في لعبة التخمين :\nٴ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n".."⌔︙ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n".."⌔︙سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ")
redis:setex('GLOBLA:'..bot_id.."Status:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
elseif text == "محيبس" or text == "بات" then
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Game:Group"..msg.chat_id_) then   
Num = math.random(1,6)
redis:set('GLOBLA:'..bot_id.."Status:Games:Bat"..msg.chat_id_,Num) 
send(msg.chat_id_, msg.id_,[[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
redis:setex('GLOBLA:'..bot_id.."Status:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
...
redis:del('GLOBLA:'..bot_id.."Status:Set:Moktlf:Bot"..msg.chat_id_)
redis:set('GLOBLA:'..bot_id.."Status::Set:Moktlf"..msg.chat_id_,name)
...
redis:set('GLOBLA:'..bot_id.."Status:Set:Amth"..msg.chat_id_,name)
redis:del('GLOBLA:'..bot_id.."Status:Set:Amth:Bot"..msg.chat_id_)
...
𓂅 .GLOBLA TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [Install source](https://t.me/GloBlA/205)

𓂅 . [Channel GLOBLA](http://t.me/GlObLa)     

𓂅 . [Group Source®](https://t.me/joinchat/PvmuH1hjmIg3F7bRGvpJMw)     

𓂅 . [Developer source](http://t.me/YYBYY) 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
𓂅 . [TWS GLOBLA](t.me/YYBYYBOT)     
]]) 
...
local edit = redis:get('GLOBLA:'..bot_id..'Num:Message:Edit'..msg.chat_id_..msg.sender_user_id_) or 0
send(msg.chat_id_, msg.id_,'⌔︙عدد التعديلات هنا *~ '..edit..'*') 
elseif text == 'جهاتي' then
local addmem = redis:get('GLOBLA:'..bot_id.."Num:Add:Memp"..msg.chat_id_..":"..msg.sender_user_id_) or 0
send(msg.chat_id_, msg.id_,'⌔︙عدد جهاتك المضافه هنا *~ '..addmem..'*') 
elseif text == "مجوهراتي" then 
local Num = redis:get('GLOBLA:'..bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_) or 0
if Num == 0 then 
...
return false 
elseif tonumber(redis:get('GLOBLA:'..bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,"⌔︙ليس لديك جواهر من الالعاب \n⌔︙اذا كنت تريد ربح الجواهر \n⌔︙ارسل الالعاب وابدأ اللعب ! ") 
else
local NUM_GAMES = redis:get('GLOBLA:'..bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,"\n⌔︙ليس لديك جواهر بهاذا العدد \n⌔︙لزيادة مجوهراتك في اللعبه \n⌔︙ارسل الالعاب وابدأ اللعب !") 
return false 
end
local NUMNKO = (NUMPY * 50)
redis:decrby('GLOBLA:'..bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_,NUMPY)  
redis:incrby('GLOBLA:'..bot_id.."Num:Message:User"..msg.chat_id_..":"..msg.sender_user_id_,NUMNKO)  
...
redis:set('GLOBLA:'..bot_id.."Status:id:user"..msg.chat_id_,zain)  
redis:setex('GLOBLA:'..bot_id.."Status:Add:msg:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
redis:set('GLOBLA:'..bot_id.."Status:idgem:user"..msg.chat_id_,zain)  
redis:setex('GLOBLA:'..bot_id.."Status:gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
send(msg.chat_id_, msg.id_, "⌔︙ارسل لي عدد المجوهرات الان") 
elseif text and text:match("^اضف مجوهرات (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
function reply(extra, result, success)
redis:incrby('GLOBLA:'..bot_id.."Num:Add:Games"..msg.chat_id_..result.sender_user_id_,text:match("^اضف مجوهرات (%d+)$"))  
...
elseif text and text:match("^اضف رسائل (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
function reply(extra, result, success)
redis:del('GLOBLA:'..bot_id.."Status:Msg_User"..msg.chat_id_..":"..result.sender_user_id_) 
redis:incrby('GLOBLA:'..bot_id.."Num:Message:Userr"..msg.chat_id_..":"..result.sender_user_id_,text:match("^اضف رسائل (%d+)$"))  
send(msg.chat_id_, msg.id_, "⌔︙تم اضافه عدد الرسائل : "..text:match("^اضف رسائل (%d+)$").." ")  
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
return false
elseif text == "تنظيف المشتركين" and Sudo_Id(msg) then
local pv = redis:smembers('GLOBLA:'..bot_id..'Users:ids')  
local sendok = 0
for i = 1, #pv do
tdcli_function({ID='GetChat',chat_id_ = pv[i]},function(arg,dataq)
...
return false
elseif text == "تنظيف الكروبات" and Sudo_Id(msg) then
local group = redis:smembers('GLOBLA:'..bot_id..'Groups_Users')  
local w = 0
local q = 0
for i = 1, #group do
...
redis:srem('GLOBLA:'..bot_id.."Removal:User:Group"..msg.chat_id_,result.id_)
redis:srem('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,result.id_)
redis:srem('GLOBLA:'..bot_id.."Keed:User:Group"..msg.chat_id_,result.id_)
...
function Function_Status(extra, result, success)
if result.id_ then
if redis:sismember('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,result.id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if redis:sismember('GLOBLA:'..bot_id.."Keed:User:Group"..msg.chat_id_,result.id_) then
Zain = "مقيد"
else
Zain = "غير مقيد"
end
if redis:sismember('GLOBLA:'..bot_id.."Removal:User:Group"..msg.chat_id_,result.id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if redis:sismember('GLOBLA:'..bot_id.."Removal:User:Groups",result.id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
function Function_Status(extra, result, success)
if redis:sismember('GLOBLA:'..bot_id.."Silence:User:Group"..msg.chat_id_,result.sender_user_id_) then
Muted = "مكتوم"
else
Muted = "غير مكتوم"
end
if redis:sismember('GLOBLA:'..bot_id.."Keed:User:Group"..msg.chat_id_,result.sender_user_id_) then
Zain = "مقيد"
else
Zain = "غير مقيد"
end
if redis:sismember('GLOBLA:'..bot_id.."Removal:User:Group"..msg.chat_id_,result.sender_user_id_) then
Ban = "محظور"
else
Ban = "غير محظور"
end
if redis:sismember('GLOBLA:'..bot_id.."Removal:User:Groups",result.sender_user_id_) then
GBan = "محظور عام"
else
GBan = "غير محظور عام"
end
...
redis:sadd('GLOBLA:'..bot_id..'Admin:Group'..msg.chat_id_, admins[i].user_id_)
num2 = num2 + 1
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,b) 
if b.username_ == true then
end
if b.first_name_ == false then
redis:srem('GLOBLA:'..bot_id..'Admin:Group'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
redis:sadd('GLOBLA:'..bot_id..'Admin:Group'..msg.chat_id_, admins[i].user_id_)
...
local UserName = (b.username_ or "IlIl19")
...
redis:sadd('GLOBLA:'..bot_id.."President:User"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
elseif text and text:match("^تعين عدد الاعضاء (%d+)$") and Sudo_Id(msg) then
redis:set('GLOBLA:'..bot_id..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
send(msg.chat_id_, msg.id_,'*⌔︙ تم تعيين عدد اعضاء تفعيل البوت اكثر من : '..text:match("تعين عدد الاعضاء (%d+)$")..' عضو *')
elseif text =='الاحصائيات' and DeveloperBot(msg) then 
send(msg.chat_id_, msg.id_,'*⌔︙عدد احصائيات البوت الكامله \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n⌔︙عدد المجموعات : '..(redis:scard('GLOBLA:'..bot_id..'Groups_Users') or 0)..'\n⌔︙عدد المشتركين : '..(redis:scard('GLOBLA:'..bot_id..'Users:ids') or 0)..'*')
elseif text == 'المطور' or text == 'مطور' then
local TextingDevGLOBLA = redis:get('GLOBLA:'..bot_id..'Texting:DevGLOBLA')
if TextingDevGLOBLA then 
send(msg.chat_id_, msg.id_,TextingDevGLOBLA)
else
send(msg.chat_id_, msg.id_,'['..UserName..']')
end
elseif text == 'حذف كليشه المطور' and Sudo_Id(msg) then
redis:del('GLOBLA:'..bot_id..'Texting:DevGLOBLA')
send(msg.chat_id_, msg.id_,'⌔︙ تم حذف كليشه المطور')
end
end
...
send(msg.chat_id_, msg.id_,'⌔︙لا تستطيع تفعيل المجموعه بسبب قلة عدد اعضاء المجموعه يجب ان يكون اكثر من *:'..(redis:get('GLOBLA:'..bot_id..'Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
owner_id = admins[i].user_id_
redis:sadd('GLOBLA:'..bot_id.."President:User"..msg.chat_id_,owner_id)
end
end
end,nil)   
...
sendText(SUDO,'⌔︙تم تفعيل مجموعه جديده\n'..'\n⌔︙بواسطة : '..Name..''..'\n⌔︙ايدي المجموعه : `'..IdChat..'`'..'\n⌔︙عدد اعضاء المجموعه *: '..NumMember..'*'..'\n⌔︙اسم المجموعه : ['..NameChat..']'..'\n⌔︙الرابط : ['..LinkGp..']',0,'md')
end
end
end,nil) 
end,nil) 
...
if not Sudo_Id(msg) then
sendText(SUDO,'⌔︙تم تعطيل مجموعه جديده\n'..'\n⌔︙بواسطة : '..Name..''..'\n⌔︙ايدي المجموعه : `'..IdChat..'`\n⌔︙اسم المجموعه : ['..NameChat..']',0,'md')
end
end
end,nil) 
end,nil) 
...
------------------------------------------------------------------------------------------------------------
if text == 'تفعيل' and not DeveloperBot(msg) and not redis:get('GLOBLA:'..bot_id..'Free:Bot') then
if AddChannel(msg.sender_user_id_) == false then
send(msg.chat_id_,msg.id_,'\n⌔︙عليك الاشتراك بالقناة البوت واستخدم البوت. \n⌔︙قناة البوت 📁.\n- @IlIl19')   
return false
end
...
redis:sadd('GLOBLA:'..bot_id..'Groups_Users',msg.chat_id_)  
redis:sadd('GLOBLA:'..bot_id..'President:User'..msg.chat_id_, msg.sender_user_id_)
...
redis:set('GLOBLA:'..bot_id..'Save:Username'..msg.sender_user_id_,data.username_)
end;end,nil)   
--------------------------------------------------------------------------------------------------------------
...
local mem_id = msg.content_.members_  
local Bots = redis:get('GLOBLA:'..bot_id.."Status:Lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
elseif text and not redis:sismember('GLOBLA:'..bot_id..'Spam_For_Bot'..msg.sender_user_id_,text) then
redis:del('GLOBLA:'..bot_id..'Spam_For_Bot'..msg.sender_user_id_) 

end

--------------------------------------------------------------------------------------------------------------
Sudo_Id_File(msg,data)
FilesGLOBLABot(msg,data)
...
redis:incr('GLOBLA:'..bot_id..'Num:Message:Edit'..result.chat_id_..result.sender_user_id_)
if redis:get('GLOBLA:'..bot_id.."Status:Lock:edit"..result.chat_id_) and not textedit and not PresidentGroup(result) then
Delete_Message(result.chat_id_,{[0] = data.message_id_}) 
local list = redis:smembers('GLOBLA:'..bot_id.."Basic:User"..result.chat_id_)
if #list == 0 then
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Link"..msg.chat_id_) then
Delete_Message(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
...
if redis:get('GLOBLA:'..bot_id.."Status:Lock:User:Name"..msg.chat_id_) then
Delete_Message(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
elseif textedit and textedit:match("@") then
...
elseif textedit and textedit:match("(.*)(#)(.*)") then
if redis:get('GLOBLA:'..bot_id.."Status:Lock:hashtak"..msg.chat_id_) then
Delete_Message(result.chat_id_,{[0] = data.message_id_}) 
return false
end  
elseif textedit and textedit:match("#") then
...
elseif textedit and textedit:match("/") then
if redis:get('GLOBLA:'..bot_id.."Status:Lock:Cmd"..msg.chat_id_) then
Delete_Message(result.chat_id_,{[0] = data.message_id_}) 
return false
end 
elseif textedit and textedit:match("(.*)(/)(.*)") then
...
local Text_Filter = redis:get('GLOBLA:'..bot_id.."Filter:Reply2"..textedit..result.chat_id_)   
if Text_Filter then    
Delete_Message(result.chat_id_, {[0] = data.message_id_})     
