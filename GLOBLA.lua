...
---------------------------------------------
if not redis:get(ZAINGLOBLA.."SudoUserName") then
    io.write('\27[0;33m\n 📨┋Send USERNAME For Sudo_bot : ارسل يوزر (معرف) المطور الاساسي ... \n\027[00m')
    local UserName = io.read():gsub('@','')
    if UserName ~= '' then
    io.write('\27[1;35m\n 🔄┋Done Save USERNAME : تم حفظ يوزر (معرف) المطور الاساسي \n\27[0;33;49m')
    redis:set(ZAINGLOBLA.."SudoUserName",'@'..UserName)
    else
    io.write('\n\27[1;31m\n🔄┋USER was not saved : لم يتم حفظ يوزر المطور \n\27[0;39;49m')
    end 
    os.execute('lua GLOBLA.lua')
end
---------------------------------------------
...
SUDO = redis:get(ZAINGLOBLA.."Send_Id"),
UserName = redis:get(ZAINGLOBLA.."SudoUserName"),
 }
create(config, "./Info.lua")   
end 
zaininfo = {}
zaininfo.id = redis:get(ZAINGLOBLA.."Send_Id")
...
redis:del(ZAINGLOBLA.."Send_Id")
redis:del(ZAINGLOBLA.."SudoUserName"),
end  
...
if var or Dev_GLOBLA(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
𓂅 . [Source Info ](t.me/GLOBLA0)     

𓂅 . [GLOBLA iNDT](t.me/GLOBLA0)     
 
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
𓂅 . [TWS GLOBLA](t.me/ubuuuBoT)     
]]) 
