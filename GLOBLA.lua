...
if Info_Group.LinkGroup ~= "" then
redis:set('GLOBLA:'..bot_id.."Status:link:set:Group"..Id_Group,Info_Group.LinkGroup)   
end
end
end
...
redis:set('GLOBLA:'..bot_id.."Status:link:set:Group"..msg.chat_id_,Link)
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/GLOBLATeam/Files_GLOBLA/master/getfile.json")
if res == 200 then
...
local Get_Json, Res = https.request("https://raw.githubusercontent.com/GLOBLATeam/Files_GLOBLA/master/Files_GLOBLA/"..File_Name)
if Res == 200 then
...
if not Dev_GLOBLA(msg) and not redis:sismember('GLOBLA:'..bot_id..'User:Ban:Pv',msg.sender_user_id_) and not redis:get('GLOBLA:'..bot_id..'Status:Lock:Twasl') then
...
send(msg.chat_id_, msg.id_,'*⌔︙ عدد المجموعات الان ← { '..#group..' } مجموعه '..GLOBLA..''..taha..'\n⌔︙اصبح عدد المجموعات الان ← { '..sendok..' } مجموعات*\n')   
end
end
end,nil)
end
...
link = redis:get('GLOBLA:'..bot_id.."Status:link:set:Group"..v) or ''
if k == 1 then
t = t..'"'..v..'":{"tek":"'..NAME..'",'
else
t = t..',"'..v..'":{"tek":"'..NAME..'",'
...
redis:del('GLOBLA:'..bot_id.."Status:link:set:Group"..msg.chat_id_) 
...
test = '⌔︙روابط الكروبات \n\n'
for k,v in pairs(list) do 
local link = redis:get('GLOBLA:'..bot_id.."Status:link:set:Group"..v)   
...
local link = redis:get('GLOBLA:'..bot_id.."Status:link:set:Group"..msg.chat_id_)            
if link then                              
...
send(msg.chat_id_,msg.id_,"- Link group :\n••━━━━━━━━━━••\n ["..linkgpp.result.."]")
redis:set('GLOBLA:'..bot_id.."Status:link:set:Group"..msg.chat_id_,linkgpp.result)
else
...
if redis:get('GLOBLA:'..bot_id.."Status:Broadcasting:Bot") and not Dev_GLOBLA(msg) then 
...
redis:set('GLOBLA:'..bot_id.."Status:id:user"..msg.chat_id_,taha)  
...
redis:set('GLOBLA:'..bot_id.."Status:idgem:user"..msg.chat_id_,taha)  
